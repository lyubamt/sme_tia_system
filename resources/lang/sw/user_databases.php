...
return [
    ...
    'index_route_description' => 'Retrieve existing user databases.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user database property name where the value is the assigned value to the retrieved user database.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user database.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user databases per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user database.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user database.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user database.',
    ...
    'show_route_description' => 'Retrieve existsing user database.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user database to retrieve',
    'destroy_route_description' => 'Delete existsing user database.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user database to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user databases.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user database.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user database does not exists.',
    ...
    'create' => 'Create New User Database',
    'delete' => 'Delete User Database',
    'edit' => 'Edit User Database',
    'show' => 'Show User Database',
    'show_all' => 'Show All User Database',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Database.',
    'none_available' => 'No User Databases Available.',
    'model_plural' => 'User Databases',
    'model_was_added' => 'User Database was successfully added.',
    'model_was_retrieved' => 'User Database was successfully retrieved.',
    'models_were_retrieved' => 'User Databases were successfully retrieved.',
    'model_was_updated' => 'User Database was successfully updated.',
    'model_was_deleted' => 'User Database was successfully deleted.',
    ...
    'model_id_camel_case' => 'user databaseId',
