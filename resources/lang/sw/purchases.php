...
return [
    ...
    'order_id' => 'Order',
    'order_id__placeholder' => 'Select order',
    'item_id' => 'Item',
    'item_id__placeholder' => 'Select item',
    'inventory_type_id' => 'Inventory Type',
    'inventory_type_id__placeholder' => 'Select inventory type',
    'size_id' => 'Size',
    'size_id__placeholder' => 'Select size',
    'quantity' => 'Quantity',
    'quantity__placeholder' => 'Enter quantity here...',
    'cost_before_tax' => 'Cost Before Tax',
    'cost_before_tax__placeholder' => 'Enter cost before tax here...',
    'cost_after_tax' => 'Cost After Tax',
    'cost_after_tax__placeholder' => 'Enter cost after tax here...',
    'transport_cost' => 'Transport Cost',
    'transport_cost__placeholder' => 'Enter transport cost here...',
    'total_cost' => 'Total Cost',
    'total_cost__placeholder' => 'Enter total cost here...',
    'paid' => 'Paid',
    'paid__placeholder' => 'Enter paid here...',
    'receipt' => 'Receipt',
    'receipt__placeholder' => 'Enter receipt here...',
    'partner_id' => 'Partner',
    'partner_id__placeholder' => 'Select partner',
    'user_id' => 'User',
    ...
    'index_route_description' => 'Retrieve existing purchases.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the purchase property name where the value is the assigned value to the retrieved purchase.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved purchase.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of purchases per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved purchase.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new purchase.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing purchase.',
    ...
    'show_route_description' => 'Retrieve existsing purchase.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the purchase to retrieve',
    'destroy_route_description' => 'Delete existsing purchase.',
    ...
    'the_id_of_model_to_delete' => 'The id of the purchase to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete purchases.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the purchase.',
    ...
    'the_requested_model_does_not_exists' => 'The requested purchase does not exists.',
    ...
    'edit' => 'Edit Purchase',
    'show' => 'Show Purchase',
    'show_all' => 'Show All Purchase',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Purchase.',
    'none_available' => 'No Purchases Available.',
    'model_plural' => 'Purchases',
    'model_was_added' => 'Purchase was successfully added.',
    'model_was_retrieved' => 'Purchase was successfully retrieved.',
    'models_were_retrieved' => 'Purchases were successfully retrieved.',
    'model_was_updated' => 'Purchase was successfully updated.',
    'model_was_deleted' => 'Purchase was successfully deleted.',
    ...
    'model_id_camel_case' => 'purchaseId',
