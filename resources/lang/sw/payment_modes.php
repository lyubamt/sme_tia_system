...
return [
    ...
    'index_route_description' => 'Retrieve existing payment modes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the payment mode property name where the value is the assigned value to the retrieved payment mode.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved payment mode.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of payment modes per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved payment mode.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new payment mode.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing payment mode.',
    ...
    'show_route_description' => 'Retrieve existsing payment mode.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the payment mode to retrieve',
    'destroy_route_description' => 'Delete existsing payment mode.',
    ...
    'the_id_of_model_to_delete' => 'The id of the payment mode to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete payment modes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the payment mode.',
    ...
    'the_requested_model_does_not_exists' => 'The requested payment mode does not exists.',
    ...
    'create' => 'Create New Payment Mode',
    'delete' => 'Delete Payment Mode',
    'edit' => 'Edit Payment Mode',
    'show' => 'Show Payment Mode',
    'show_all' => 'Show All Payment Mode',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Payment Mode.',
    'none_available' => 'No Payment Modes Available.',
    'model_plural' => 'Payment Modes',
    'model_was_added' => 'Payment Mode was successfully added.',
    'model_was_retrieved' => 'Payment Mode was successfully retrieved.',
    'models_were_retrieved' => 'Payment Modes were successfully retrieved.',
    'model_was_updated' => 'Payment Mode was successfully updated.',
    'model_was_deleted' => 'Payment Mode was successfully deleted.',
    ...
    'model_id_camel_case' => 'payment modeId',
