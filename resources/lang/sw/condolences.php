...
return [
    ...
    'member_relative_id' => 'Member Relative',
    'member_relative_id__placeholder' => 'Select member relative',
    'day' => 'Day',
    ...
    'index_route_description' => 'Retrieve existing condolences.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the condolence property name where the value is the assigned value to the retrieved condolence.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved condolence.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of condolences per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved condolence.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new condolence.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing condolence.',
    ...
    'show_route_description' => 'Retrieve existsing condolence.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the condolence to retrieve',
    'destroy_route_description' => 'Delete existsing condolence.',
    ...
    'the_id_of_model_to_delete' => 'The id of the condolence to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete condolences.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the condolence.',
    ...
    'the_requested_model_does_not_exists' => 'The requested condolence does not exists.',
    ...
    'create' => 'Create New Condolence',
    'delete' => 'Delete Condolence',
    'edit' => 'Edit Condolence',
    'show' => 'Show Condolence',
    'show_all' => 'Show All Condolence',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Condolence.',
    'none_available' => 'No Condolences Available.',
    'model_plural' => 'Condolences',
    'model_was_added' => 'Condolence was successfully added.',
    'model_was_retrieved' => 'Condolence was successfully retrieved.',
    'models_were_retrieved' => 'Condolences were successfully retrieved.',
    'model_was_updated' => 'Condolence was successfully updated.',
    'model_was_deleted' => 'Condolence was successfully deleted.',
    ...
    'model_id_camel_case' => 'condolenceId',
