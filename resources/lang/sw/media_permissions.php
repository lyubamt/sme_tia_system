...
return [
    ...
    'media_archive_id' => 'Media Archive',
    'media_archive_id__placeholder' => 'Select media archive',
    'user_id' => 'User',
    ...
    'index_route_description' => 'Retrieve existing media permissions.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the media permission property name where the value is the assigned value to the retrieved media permission.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved media permission.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of media permissions per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved media permission.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new media permission.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing media permission.',
    ...
    'show_route_description' => 'Retrieve existsing media permission.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the media permission to retrieve',
    'destroy_route_description' => 'Delete existsing media permission.',
    ...
    'the_id_of_model_to_delete' => 'The id of the media permission to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete media permissions.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the media permission.',
    ...
    'the_requested_model_does_not_exists' => 'The requested media permission does not exists.',
    ...
    'create' => 'Create New Media Permission',
    'delete' => 'Delete Media Permission',
    'edit' => 'Edit Media Permission',
    'show' => 'Show Media Permission',
    'show_all' => 'Show All Media Permission',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Media Permission.',
    'none_available' => 'No Media Permissions Available.',
    'model_plural' => 'Media Permissions',
    'model_was_added' => 'Media Permission was successfully added.',
    'model_was_retrieved' => 'Media Permission was successfully retrieved.',
    'models_were_retrieved' => 'Media Permissions were successfully retrieved.',
    'model_was_updated' => 'Media Permission was successfully updated.',
    'model_was_deleted' => 'Media Permission was successfully deleted.',
    ...
    'model_id_camel_case' => 'media permissionId',
