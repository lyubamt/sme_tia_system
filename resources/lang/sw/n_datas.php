...
return [
    ...
    'index_route_description' => 'Retrieve existing n datas.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the n data property name where the value is the assigned value to the retrieved n data.',
    ...
    'show_route_description' => 'Retrieve existsing n data.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the n data to retrieve',
    'destroy_route_description' => 'Delete existsing n data.',
    ...
    'the_id_of_model_to_delete' => 'The id of the n data to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete n datas.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the n data.',
    ...
    'the_requested_model_does_not_exists' => 'The requested n data does not exists.',
    ...
    'create' => 'Create New N Data',
    'delete' => 'Delete N Data',
    'edit' => 'Edit N Data',
    'show' => 'Show N Data',
    'show_all' => 'Show All N Data',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete N Data.',
    'none_available' => 'No N Datas Available.',
    'model_plural' => 'N Datas',
    'model_was_added' => 'N Data was successfully added.',
    'model_was_retrieved' => 'N Data was successfully retrieved.',
    'models_were_retrieved' => 'N Datas were successfully retrieved.',
    'model_was_updated' => 'N Data was successfully updated.',
    'model_was_deleted' => 'N Data was successfully deleted.',
