...
return [
    ...
    'index_route_description' => 'Retrieve existing storage categories.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the storage category property name where the value is the assigned value to the retrieved storage category.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved storage category.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of storage categories per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved storage category.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new storage category.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing storage category.',
    ...
    'show_route_description' => 'Retrieve existsing storage category.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the storage category to retrieve',
    'destroy_route_description' => 'Delete existsing storage category.',
    ...
    'the_id_of_model_to_delete' => 'The id of the storage category to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete storage categories.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the storage category.',
    ...
    'the_requested_model_does_not_exists' => 'The requested storage category does not exists.',
    ...
    'create' => 'Create New Storage Category',
    'delete' => 'Delete Storage Category',
    'edit' => 'Edit Storage Category',
    'show' => 'Show Storage Category',
    'show_all' => 'Show All Storage Category',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Storage Category.',
    'none_available' => 'No Storage Categories Available.',
    'model_plural' => 'Storage Categories',
    'model_was_added' => 'Storage Category was successfully added.',
    'model_was_retrieved' => 'Storage Category was successfully retrieved.',
    'models_were_retrieved' => 'Storage Categories were successfully retrieved.',
    'model_was_updated' => 'Storage Category was successfully updated.',
    'model_was_deleted' => 'Storage Category was successfully deleted.',
    ...
    'model_id_camel_case' => 'storage categoryId',
