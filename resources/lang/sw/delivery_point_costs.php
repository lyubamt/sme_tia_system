...
return [
    ...
    'index_route_description' => 'Retrieve existing delivery point costs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the delivery point cost property name where the value is the assigned value to the retrieved delivery point cost.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved delivery point cost.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of delivery point costs per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved delivery point cost.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new delivery point cost.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing delivery point cost.',
    ...
    'show_route_description' => 'Retrieve existsing delivery point cost.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the delivery point cost to retrieve',
    'destroy_route_description' => 'Delete existsing delivery point cost.',
    ...
    'the_id_of_model_to_delete' => 'The id of the delivery point cost to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete delivery point costs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the delivery point cost.',
    ...
    'the_requested_model_does_not_exists' => 'The requested delivery point cost does not exists.',
    ...
    'create' => 'Create New Delivery Point Cost',
    'delete' => 'Delete Delivery Point Cost',
    'edit' => 'Edit Delivery Point Cost',
    'show' => 'Show Delivery Point Cost',
    'show_all' => 'Show All Delivery Point Cost',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Delivery Point Cost.',
    'none_available' => 'No Delivery Point Costs Available.',
    'model_plural' => 'Delivery Point Costs',
    'model_was_added' => 'Delivery Point Cost was successfully added.',
    'model_was_retrieved' => 'Delivery Point Cost was successfully retrieved.',
    'models_were_retrieved' => 'Delivery Point Costs were successfully retrieved.',
    'model_was_updated' => 'Delivery Point Cost was successfully updated.',
    'model_was_deleted' => 'Delivery Point Cost was successfully deleted.',
    ...
    'model_id_camel_case' => 'delivery point costId',
