...
return [
    ...
    'index_route_description' => 'Retrieve existing member relatives.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the member relative property name where the value is the assigned value to the retrieved member relative.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved member relative.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of member relatives per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved member relative.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new member relative.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing member relative.',
    ...
    'show_route_description' => 'Retrieve existsing member relative.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the member relative to retrieve',
    'destroy_route_description' => 'Delete existsing member relative.',
    ...
    'the_id_of_model_to_delete' => 'The id of the member relative to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete member relatives.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the member relative.',
    ...
    'the_requested_model_does_not_exists' => 'The requested member relative does not exists.',
    ...
    'create' => 'Create New Member Relative',
    'delete' => 'Delete Member Relative',
    'edit' => 'Edit Member Relative',
    'show' => 'Show Member Relative',
    'show_all' => 'Show All Member Relative',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Member Relative.',
    'none_available' => 'No Member Relatives Available.',
    'model_plural' => 'Member Relatives',
    'model_was_added' => 'Member Relative was successfully added.',
    'model_was_retrieved' => 'Member Relative was successfully retrieved.',
    'models_were_retrieved' => 'Member Relatives were successfully retrieved.',
    'model_was_updated' => 'Member Relative was successfully updated.',
    'model_was_deleted' => 'Member Relative was successfully deleted.',
    ...
    'model_id_camel_case' => 'member relativeId',
