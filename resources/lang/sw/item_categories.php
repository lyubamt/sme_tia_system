...
return [
    ...
    'index_route_description' => 'Retrieve existing item categories.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the item category property name where the value is the assigned value to the retrieved item category.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved item category.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of item categories per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved item category.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new item category.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing item category.',
    ...
    'show_route_description' => 'Retrieve existsing item category.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the item category to retrieve',
    'destroy_route_description' => 'Delete existsing item category.',
    ...
    'the_id_of_model_to_delete' => 'The id of the item category to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete item categories.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the item category.',
    ...
    'the_requested_model_does_not_exists' => 'The requested item category does not exists.',
    ...
    'create' => 'Create New Item Category',
    'delete' => 'Delete Item Category',
    'edit' => 'Edit Item Category',
    'show' => 'Show Item Category',
    'show_all' => 'Show All Item Category',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Item Category.',
    'none_available' => 'No Item Categories Available.',
    'model_plural' => 'Item Categories',
    'model_was_added' => 'Item Category was successfully added.',
    'model_was_retrieved' => 'Item Category was successfully retrieved.',
    'models_were_retrieved' => 'Item Categories were successfully retrieved.',
    'model_was_updated' => 'Item Category was successfully updated.',
    'model_was_deleted' => 'Item Category was successfully deleted.',
    ...
    'model_id_camel_case' => 'item categoryId',
