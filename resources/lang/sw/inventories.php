...
return [
    ...
    'cost' => 'Cost',
    'cost__placeholder' => 'Enter cost here...',
    'minimum_quantity' => 'Minimum Quantity',
    'minimum_quantity__placeholder' => 'Enter minimum quantity here...',
    'maxmum_quantity' => 'Maxmum Quantity',
    'maxmum_quantity__placeholder' => 'Enter maxmum quantity here...',
    ...
    'index_route_description' => 'Retrieve existing inventories.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the inventory property name where the value is the assigned value to the retrieved inventory.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved inventory.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of inventories per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved inventory.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new inventory.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing inventory.',
    ...
    'show_route_description' => 'Retrieve existsing inventory.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the inventory to retrieve',
    'destroy_route_description' => 'Delete existsing inventory.',
    ...
    'the_id_of_model_to_delete' => 'The id of the inventory to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete inventories.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the inventory.',
    ...
    'the_requested_model_does_not_exists' => 'The requested inventory does not exists.',
    ...
    'edit' => 'Edit Inventory',
    'show' => 'Show Inventory',
    'show_all' => 'Show All Inventory',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Inventory.',
    'none_available' => 'No Inventories Available.',
    'model_plural' => 'Inventories',
    'model_was_added' => 'Inventory was successfully added.',
    'model_was_retrieved' => 'Inventory was successfully retrieved.',
    'models_were_retrieved' => 'Inventories were successfully retrieved.',
    'model_was_updated' => 'Inventory was successfully updated.',
    'model_was_deleted' => 'Inventory was successfully deleted.',
    ...
    'model_id_camel_case' => 'inventoryId',
