...
return [
    ...
    'index_route_description' => 'Retrieve existing transport means.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the transport mean property name where the value is the assigned value to the retrieved transport mean.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved transport mean.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of transport means per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved transport mean.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new transport mean.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing transport mean.',
    ...
    'show_route_description' => 'Retrieve existsing transport mean.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the transport mean to retrieve',
    'destroy_route_description' => 'Delete existsing transport mean.',
    ...
    'the_id_of_model_to_delete' => 'The id of the transport mean to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete transport means.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the transport mean.',
    ...
    'the_requested_model_does_not_exists' => 'The requested transport mean does not exists.',
    ...
    'create' => 'Create New Transport Mean',
    'delete' => 'Delete Transport Mean',
    'edit' => 'Edit Transport Mean',
    'show' => 'Show Transport Mean',
    'show_all' => 'Show All Transport Mean',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Transport Mean.',
    'none_available' => 'No Transport Means Available.',
    'model_plural' => 'Transport Means',
    'model_was_added' => 'Transport Mean was successfully added.',
    'model_was_retrieved' => 'Transport Mean was successfully retrieved.',
    'models_were_retrieved' => 'Transport Means were successfully retrieved.',
    'model_was_updated' => 'Transport Mean was successfully updated.',
    'model_was_deleted' => 'Transport Mean was successfully deleted.',
    ...
    'model_id_camel_case' => 'transport meanId',
