...
return [
    ...
    'index_route_description' => 'Retrieve existing scales.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the scale property name where the value is the assigned value to the retrieved scale.',
    ...
    'show_route_description' => 'Retrieve existsing scale.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the scale to retrieve',
    'destroy_route_description' => 'Delete existsing scale.',
    ...
    'the_id_of_model_to_delete' => 'The id of the scale to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete scales.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the scale.',
    ...
    'the_requested_model_does_not_exists' => 'The requested scale does not exists.',
    ...
    'create' => 'Create New Scale',
    'delete' => 'Delete Scale',
    'edit' => 'Edit Scale',
    'show' => 'Show Scale',
    'show_all' => 'Show All Scale',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Scale.',
    'none_available' => 'No Scales Available.',
    'model_plural' => 'Scales',
    'model_was_added' => 'Scale was successfully added.',
    'model_was_retrieved' => 'Scale was successfully retrieved.',
    'models_were_retrieved' => 'Scales were successfully retrieved.',
    'model_was_updated' => 'Scale was successfully updated.',
    'model_was_deleted' => 'Scale was successfully deleted.',
