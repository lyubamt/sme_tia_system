...
return [
    ...
    'index_route_description' => 'Retrieve existing time zones.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the time zone property name where the value is the assigned value to the retrieved time zone.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved time zone.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of time zones per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved time zone.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new time zone.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing time zone.',
    ...
    'show_route_description' => 'Retrieve existsing time zone.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the time zone to retrieve',
    'destroy_route_description' => 'Delete existsing time zone.',
    ...
    'the_id_of_model_to_delete' => 'The id of the time zone to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete time zones.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the time zone.',
    ...
    'the_requested_model_does_not_exists' => 'The requested time zone does not exists.',
    ...
    'create' => 'Create New Time Zone',
    'delete' => 'Delete Time Zone',
    'edit' => 'Edit Time Zone',
    'show' => 'Show Time Zone',
    'show_all' => 'Show All Time Zone',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Time Zone.',
    'none_available' => 'No Time Zones Available.',
    'model_plural' => 'Time Zones',
    'model_was_added' => 'Time Zone was successfully added.',
    'model_was_retrieved' => 'Time Zone was successfully retrieved.',
    'models_were_retrieved' => 'Time Zones were successfully retrieved.',
    'model_was_updated' => 'Time Zone was successfully updated.',
    'model_was_deleted' => 'Time Zone was successfully deleted.',
    ...
    'model_id_camel_case' => 'time zoneId',
