...
return [
    ...
    'index_route_description' => 'Retrieve existing logs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the log property name where the value is the assigned value to the retrieved log.',
    ...
    'show_route_description' => 'Retrieve existsing log.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the log to retrieve',
    'destroy_route_description' => 'Delete existsing log.',
    ...
    'the_id_of_model_to_delete' => 'The id of the log to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete logs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the log.',
    ...
    'the_requested_model_does_not_exists' => 'The requested log does not exists.',
    ...
    'edit' => 'Edit Log',
    'show' => 'Show Log',
    'show_all' => 'Show All Log',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Log.',
    'none_available' => 'No Logs Available.',
    'model_plural' => 'Logs',
    'model_was_added' => 'Log was successfully added.',
    'model_was_retrieved' => 'Log was successfully retrieved.',
    'models_were_retrieved' => 'Logs were successfully retrieved.',
    'model_was_updated' => 'Log was successfully updated.',
    'model_was_deleted' => 'Log was successfully deleted.',
