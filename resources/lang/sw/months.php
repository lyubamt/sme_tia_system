...
return [
    ...
    'index_route_description' => 'Retrieve existing months.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the month property name where the value is the assigned value to the retrieved month.',
    ...
    'show_route_description' => 'Retrieve existsing month.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the month to retrieve',
    'destroy_route_description' => 'Delete existsing month.',
    ...
    'the_id_of_model_to_delete' => 'The id of the month to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete months.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the month.',
    ...
    'the_requested_model_does_not_exists' => 'The requested month does not exists.',
    ...
    'create' => 'Create New Month',
    'delete' => 'Delete Month',
    'edit' => 'Edit Month',
    'show' => 'Show Month',
    'show_all' => 'Show All Month',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Month.',
    'none_available' => 'No Months Available.',
    'model_plural' => 'Months',
    'model_was_added' => 'Month was successfully added.',
    'model_was_retrieved' => 'Month was successfully retrieved.',
    'models_were_retrieved' => 'Months were successfully retrieved.',
    'model_was_updated' => 'Month was successfully updated.',
    'model_was_deleted' => 'Month was successfully deleted.',
