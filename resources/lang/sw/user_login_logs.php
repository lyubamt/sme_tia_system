...
return [
    ...
    'http_client_ip__placeholder' => 'Enter http client ip here...',
    'http_x_forwarded_for' => 'Http X Forwarded For',
    'http_x_forwarded_for__placeholder' => 'Enter http x forwarded for here...',
    'remote_addr' => 'Remote Addr',
    'remote_addr__placeholder' => 'Enter remote addr here...',
    'server_name' => 'Server Name',
    'server_name__placeholder' => 'Enter server name here...',
    'direction' => 'Direction',
    ...
    'index_route_description' => 'Retrieve existing user login logs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user login log property name where the value is the assigned value to the retrieved user login log.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user login log.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user login logs per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user login log.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user login log.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user login log.',
    ...
    'show_route_description' => 'Retrieve existsing user login log.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user login log to retrieve',
    'destroy_route_description' => 'Delete existsing user login log.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user login log to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user login logs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user login log.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user login log does not exists.',
    ...
    'create' => 'Create New User Login Log',
    'delete' => 'Delete User Login Log',
    'edit' => 'Edit User Login Log',
    'show' => 'Show User Login Log',
    'show_all' => 'Show All User Login Log',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Login Log.',
    'none_available' => 'No User Login Logs Available.',
    'model_plural' => 'User Login Logs',
    'model_was_added' => 'User Login Log was successfully added.',
    'model_was_retrieved' => 'User Login Log was successfully retrieved.',
    'models_were_retrieved' => 'User Login Logs were successfully retrieved.',
    'model_was_updated' => 'User Login Log was successfully updated.',
    'model_was_deleted' => 'User Login Log was successfully deleted.',
    ...
    'model_id_camel_case' => 'user login logId',
