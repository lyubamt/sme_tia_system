...
return [
    ...
    'index_route_description' => 'Retrieve existing item sub categories.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the item sub category property name where the value is the assigned value to the retrieved item sub category.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved item sub category.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of item sub categories per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved item sub category.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new item sub category.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing item sub category.',
    ...
    'show_route_description' => 'Retrieve existsing item sub category.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the item sub category to retrieve',
    'destroy_route_description' => 'Delete existsing item sub category.',
    ...
    'the_id_of_model_to_delete' => 'The id of the item sub category to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete item sub categories.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the item sub category.',
    ...
    'the_requested_model_does_not_exists' => 'The requested item sub category does not exists.',
    ...
    'create' => 'Create New Item Sub Category',
    'delete' => 'Delete Item Sub Category',
    'edit' => 'Edit Item Sub Category',
    'show' => 'Show Item Sub Category',
    'show_all' => 'Show All Item Sub Category',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Item Sub Category.',
    'none_available' => 'No Item Sub Categories Available.',
    'model_plural' => 'Item Sub Categories',
    'model_was_added' => 'Item Sub Category was successfully added.',
    'model_was_retrieved' => 'Item Sub Category was successfully retrieved.',
    'models_were_retrieved' => 'Item Sub Categories were successfully retrieved.',
    'model_was_updated' => 'Item Sub Category was successfully updated.',
    'model_was_deleted' => 'Item Sub Category was successfully deleted.',
    ...
    'model_id_camel_case' => 'item sub categoryId',
