...
return [
    ...
    'descrption__placeholder' => 'Enter descrption here...',
    'status' => 'Status',
    'status__placeholder' => 'Enter status here...',
    'position' => 'Position',
    'position__placeholder' => 'Enter position here...',
    ...
    'index_route_description' => 'Retrieve existing system settings.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the system setting property name where the value is the assigned value to the retrieved system setting.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved system setting.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of system settings per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved system setting.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new system setting.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing system setting.',
    ...
    'show_route_description' => 'Retrieve existsing system setting.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the system setting to retrieve',
    'destroy_route_description' => 'Delete existsing system setting.',
    ...
    'the_id_of_model_to_delete' => 'The id of the system setting to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete system settings.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the system setting.',
    ...
    'the_requested_model_does_not_exists' => 'The requested system setting does not exists.',
    ...
    'create' => 'Create New System Setting',
    'delete' => 'Delete System Setting',
    'edit' => 'Edit System Setting',
    'show' => 'Show System Setting',
    'show_all' => 'Show All System Setting',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete System Setting.',
    'none_available' => 'No System Settings Available.',
    'model_plural' => 'System Settings',
    'model_was_added' => 'System Setting was successfully added.',
    'model_was_retrieved' => 'System Setting was successfully retrieved.',
    'models_were_retrieved' => 'System Settings were successfully retrieved.',
    'model_was_updated' => 'System Setting was successfully updated.',
    'model_was_deleted' => 'System Setting was successfully deleted.',
    ...
    'model_id_camel_case' => 'system settingId',
