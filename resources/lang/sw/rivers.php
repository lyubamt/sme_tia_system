...
return [
    ...
    'index_route_description' => 'Retrieve existing rivers.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the river property name where the value is the assigned value to the retrieved river.',
    ...
    'show_route_description' => 'Retrieve existsing river.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the river to retrieve',
    'destroy_route_description' => 'Delete existsing river.',
    ...
    'the_id_of_model_to_delete' => 'The id of the river to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete rivers.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the river.',
    ...
    'the_requested_model_does_not_exists' => 'The requested river does not exists.',
    ...
    'create' => 'Create New River',
    'delete' => 'Delete River',
    'edit' => 'Edit River',
    'show' => 'Show River',
    'show_all' => 'Show All River',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete River.',
    'none_available' => 'No Rivers Available.',
    'model_plural' => 'Rivers',
    'model_was_added' => 'River was successfully added.',
    'model_was_retrieved' => 'River was successfully retrieved.',
    'models_were_retrieved' => 'Rivers were successfully retrieved.',
    'model_was_updated' => 'River was successfully updated.',
    'model_was_deleted' => 'River was successfully deleted.',
