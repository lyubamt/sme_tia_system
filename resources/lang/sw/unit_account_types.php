...
return [
    ...
    'index_route_description' => 'Retrieve existing unit account types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the unit account type property name where the value is the assigned value to the retrieved unit account type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved unit account type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of unit account types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved unit account type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new unit account type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing unit account type.',
    ...
    'show_route_description' => 'Retrieve existsing unit account type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the unit account type to retrieve',
    'destroy_route_description' => 'Delete existsing unit account type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the unit account type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete unit account types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the unit account type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested unit account type does not exists.',
    ...
    'create' => 'Create New Unit Account Type',
    'delete' => 'Delete Unit Account Type',
    'edit' => 'Edit Unit Account Type',
    'show' => 'Show Unit Account Type',
    'show_all' => 'Show All Unit Account Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Unit Account Type.',
    'none_available' => 'No Unit Account Types Available.',
    'model_plural' => 'Unit Account Types',
    'model_was_added' => 'Unit Account Type was successfully added.',
    'model_was_retrieved' => 'Unit Account Type was successfully retrieved.',
    'models_were_retrieved' => 'Unit Account Types were successfully retrieved.',
    'model_was_updated' => 'Unit Account Type was successfully updated.',
    'model_was_deleted' => 'Unit Account Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'unit account typeId',
