...
return [
    ...
    'symbol' => 'Symbol',
    'symbol__placeholder' => 'Enter symbol here...',
    ...
    'index_route_description' => 'Retrieve existing data flags.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the data flag property name where the value is the assigned value to the retrieved data flag.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved data flag.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of data flags per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved data flag.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new data flag.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing data flag.',
    ...
    'show_route_description' => 'Retrieve existsing data flag.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the data flag to retrieve',
    'destroy_route_description' => 'Delete existsing data flag.',
    ...
    'the_id_of_model_to_delete' => 'The id of the data flag to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete data flags.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the data flag.',
    ...
    'the_requested_model_does_not_exists' => 'The requested data flag does not exists.',
    ...
    'create' => 'Create New Data Flag',
    'delete' => 'Delete Data Flag',
    'edit' => 'Edit Data Flag',
    'show' => 'Show Data Flag',
    'show_all' => 'Show All Data Flag',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Data Flag.',
    'none_available' => 'No Data Flags Available.',
    'model_plural' => 'Data Flags',
    'model_was_added' => 'Data Flag was successfully added.',
    'model_was_retrieved' => 'Data Flag was successfully retrieved.',
    'models_were_retrieved' => 'Data Flags were successfully retrieved.',
    'model_was_updated' => 'Data Flag was successfully updated.',
    'model_was_deleted' => 'Data Flag was successfully deleted.',
    ...
    'model_id_camel_case' => 'data flagId',
