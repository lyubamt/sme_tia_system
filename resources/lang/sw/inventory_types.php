...
return [
    ...
    'debit' => 'Debit',
    'debit__placeholder' => 'Enter debit here...',
    'credit' => 'Credit',
    'credit__placeholder' => 'Enter credit here...',
    ...
    'index_route_description' => 'Retrieve existing inventory types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the inventory type property name where the value is the assigned value to the retrieved inventory type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved inventory type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of inventory types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved inventory type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new inventory type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing inventory type.',
    ...
    'show_route_description' => 'Retrieve existsing inventory type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the inventory type to retrieve',
    'destroy_route_description' => 'Delete existsing inventory type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the inventory type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete inventory types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the inventory type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested inventory type does not exists.',
    ...
    'create' => 'Create New Inventory Type',
    'delete' => 'Delete Inventory Type',
    'edit' => 'Edit Inventory Type',
    'show' => 'Show Inventory Type',
    'show_all' => 'Show All Inventory Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Inventory Type.',
    'none_available' => 'No Inventory Types Available.',
    'model_plural' => 'Inventory Types',
    'model_was_added' => 'Inventory Type was successfully added.',
    'model_was_retrieved' => 'Inventory Type was successfully retrieved.',
    'models_were_retrieved' => 'Inventory Types were successfully retrieved.',
    'model_was_updated' => 'Inventory Type was successfully updated.',
    'model_was_deleted' => 'Inventory Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'inventory typeId',
