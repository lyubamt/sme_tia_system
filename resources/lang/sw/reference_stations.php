...
return [
    ...
    'station_reference_purpose_id' => 'Station Reference Purpose',
    'station_reference_purpose_id__placeholder' => 'Select station reference purpose',
    'station_reference_use_id' => 'Station Reference Use',
    'station_reference_use_id__placeholder' => 'Select station reference use',
    'seq_no' => 'Seq No',
    ...
    'index_route_description' => 'Retrieve existing reference stations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the reference station property name where the value is the assigned value to the retrieved reference station.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved reference station.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of reference stations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved reference station.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new reference station.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing reference station.',
    ...
    'show_route_description' => 'Retrieve existsing reference station.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the reference station to retrieve',
    'destroy_route_description' => 'Delete existsing reference station.',
    ...
    'the_id_of_model_to_delete' => 'The id of the reference station to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete reference stations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the reference station.',
    ...
    'the_requested_model_does_not_exists' => 'The requested reference station does not exists.',
    ...
    'create' => 'Create New Reference Station',
    'delete' => 'Delete Reference Station',
    'edit' => 'Edit Reference Station',
    'show' => 'Show Reference Station',
    'show_all' => 'Show All Reference Station',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Reference Station.',
    'none_available' => 'No Reference Stations Available.',
    'model_plural' => 'Reference Stations',
    'model_was_added' => 'Reference Station was successfully added.',
    'model_was_retrieved' => 'Reference Station was successfully retrieved.',
    'models_were_retrieved' => 'Reference Stations were successfully retrieved.',
    'model_was_updated' => 'Reference Station was successfully updated.',
    'model_was_deleted' => 'Reference Station was successfully deleted.',
    ...
    'model_id_camel_case' => 'reference stationId',
