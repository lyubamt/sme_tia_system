...
return [
    ...
    'route_id' => 'Route',
    'route_id__placeholder' => 'Select route',
    'date' => 'Date',
    ...
    'index_route_description' => 'Retrieve existing storage routes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the storage route property name where the value is the assigned value to the retrieved storage route.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved storage route.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of storage routes per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved storage route.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new storage route.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing storage route.',
    ...
    'show_route_description' => 'Retrieve existsing storage route.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the storage route to retrieve',
    'destroy_route_description' => 'Delete existsing storage route.',
    ...
    'the_id_of_model_to_delete' => 'The id of the storage route to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete storage routes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the storage route.',
    ...
    'the_requested_model_does_not_exists' => 'The requested storage route does not exists.',
    ...
    'create' => 'Create New Storage Route',
    'delete' => 'Delete Storage Route',
    'edit' => 'Edit Storage Route',
    'show' => 'Show Storage Route',
    'show_all' => 'Show All Storage Route',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Storage Route.',
    'none_available' => 'No Storage Routes Available.',
    'model_plural' => 'Storage Routes',
    'model_was_added' => 'Storage Route was successfully added.',
    'model_was_retrieved' => 'Storage Route was successfully retrieved.',
    'models_were_retrieved' => 'Storage Routes were successfully retrieved.',
    'model_was_updated' => 'Storage Route was successfully updated.',
    'model_was_deleted' => 'Storage Route was successfully deleted.',
    ...
    'model_id_camel_case' => 'storage routeId',
