...
return [
    ...
    'index_route_description' => 'Retrieve existing payment types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the payment type property name where the value is the assigned value to the retrieved payment type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved payment type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of payment types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved payment type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new payment type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing payment type.',
    ...
    'show_route_description' => 'Retrieve existsing payment type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the payment type to retrieve',
    'destroy_route_description' => 'Delete existsing payment type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the payment type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete payment types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the payment type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested payment type does not exists.',
    ...
    'create' => 'Create New Payment Type',
    'delete' => 'Delete Payment Type',
    'edit' => 'Edit Payment Type',
    'show' => 'Show Payment Type',
    'show_all' => 'Show All Payment Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Payment Type.',
    'none_available' => 'No Payment Types Available.',
    'model_plural' => 'Payment Types',
    'model_was_added' => 'Payment Type was successfully added.',
    'model_was_retrieved' => 'Payment Type was successfully retrieved.',
    'models_were_retrieved' => 'Payment Types were successfully retrieved.',
    'model_was_updated' => 'Payment Type was successfully updated.',
    'model_was_deleted' => 'Payment Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'payment typeId',
