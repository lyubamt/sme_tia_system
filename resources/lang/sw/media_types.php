...
return [
    ...
    'index_route_description' => 'Retrieve existing media types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the media type property name where the value is the assigned value to the retrieved media type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved media type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of media types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved media type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new media type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing media type.',
    ...
    'show_route_description' => 'Retrieve existsing media type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the media type to retrieve',
    'destroy_route_description' => 'Delete existsing media type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the media type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete media types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the media type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested media type does not exists.',
    ...
    'create' => 'Create New Media Type',
    'delete' => 'Delete Media Type',
    'edit' => 'Edit Media Type',
    'show' => 'Show Media Type',
    'show_all' => 'Show All Media Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Media Type.',
    'none_available' => 'No Media Types Available.',
    'model_plural' => 'Media Types',
    'model_was_added' => 'Media Type was successfully added.',
    'model_was_retrieved' => 'Media Type was successfully retrieved.',
    'models_were_retrieved' => 'Media Types were successfully retrieved.',
    'model_was_updated' => 'Media Type was successfully updated.',
    'model_was_deleted' => 'Media Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'media typeId',
