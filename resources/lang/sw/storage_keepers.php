...
return [
    ...
    'index_route_description' => 'Retrieve existing storage keepers.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the storage keeper property name where the value is the assigned value to the retrieved storage keeper.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved storage keeper.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of storage keepers per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved storage keeper.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new storage keeper.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing storage keeper.',
    ...
    'show_route_description' => 'Retrieve existsing storage keeper.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the storage keeper to retrieve',
    'destroy_route_description' => 'Delete existsing storage keeper.',
    ...
    'the_id_of_model_to_delete' => 'The id of the storage keeper to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete storage keepers.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the storage keeper.',
    ...
    'the_requested_model_does_not_exists' => 'The requested storage keeper does not exists.',
    ...
    'create' => 'Create New Storage Keeper',
    'delete' => 'Delete Storage Keeper',
    'edit' => 'Edit Storage Keeper',
    'show' => 'Show Storage Keeper',
    'show_all' => 'Show All Storage Keeper',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Storage Keeper.',
    'none_available' => 'No Storage Keepers Available.',
    'model_plural' => 'Storage Keepers',
    'model_was_added' => 'Storage Keeper was successfully added.',
    'model_was_retrieved' => 'Storage Keeper was successfully retrieved.',
    'models_were_retrieved' => 'Storage Keepers were successfully retrieved.',
    'model_was_updated' => 'Storage Keeper was successfully updated.',
    'model_was_deleted' => 'Storage Keeper was successfully deleted.',
    ...
    'model_id_camel_case' => 'storage keeperId',
