...
return [
    ...
    'index_route_description' => 'Retrieve existing shares.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the share property name where the value is the assigned value to the retrieved share.',
    ...
    'show_route_description' => 'Retrieve existsing share.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the share to retrieve',
    'destroy_route_description' => 'Delete existsing share.',
    ...
    'the_id_of_model_to_delete' => 'The id of the share to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete shares.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the share.',
    ...
    'the_requested_model_does_not_exists' => 'The requested share does not exists.',
    ...
    'edit' => 'Edit Share',
    'show' => 'Show Share',
    'show_all' => 'Show All Share',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Share.',
    'none_available' => 'No Shares Available.',
    'model_plural' => 'Shares',
    'model_was_added' => 'Share was successfully added.',
    'model_was_retrieved' => 'Share was successfully retrieved.',
    'models_were_retrieved' => 'Shares were successfully retrieved.',
    'model_was_updated' => 'Share was successfully updated.',
    'model_was_deleted' => 'Share was successfully deleted.',
