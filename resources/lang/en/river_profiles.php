...
return [
    ...
    'distance' => 'Distance',
    'distance__placeholder' => 'Enter distance here...',
    'height' => 'Height',
    ...
    'index_route_description' => 'Retrieve existing river profiles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the river profile property name where the value is the assigned value to the retrieved river profile.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved river profile.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of river profiles per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved river profile.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new river profile.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing river profile.',
    ...
    'show_route_description' => 'Retrieve existsing river profile.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the river profile to retrieve',
    'destroy_route_description' => 'Delete existsing river profile.',
    ...
    'the_id_of_model_to_delete' => 'The id of the river profile to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete river profiles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the river profile.',
    ...
    'the_requested_model_does_not_exists' => 'The requested river profile does not exists.',
    ...
    'create' => 'Create New River Profile',
    'delete' => 'Delete River Profile',
    'edit' => 'Edit River Profile',
    'show' => 'Show River Profile',
    'show_all' => 'Show All River Profile',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete River Profile.',
    'none_available' => 'No River Profiles Available.',
    'model_plural' => 'River Profiles',
    'model_was_added' => 'River Profile was successfully added.',
    'model_was_retrieved' => 'River Profile was successfully retrieved.',
    'models_were_retrieved' => 'River Profiles were successfully retrieved.',
    'model_was_updated' => 'River Profile was successfully updated.',
    'model_was_deleted' => 'River Profile was successfully deleted.',
    ...
    'model_id_camel_case' => 'river profileId',
