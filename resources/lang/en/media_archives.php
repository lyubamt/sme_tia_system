...
return [
    ...
    'media_category_id__placeholder' => 'Select media category',
    'media_type_id' => 'Media Type',
    'media_type_id__placeholder' => 'Select media type',
    'file_type_id' => 'File Type',
    'file_type_id__placeholder' => 'Select file type',
    'role' => 'Role',
    'role__placeholder' => 'Enter role here...',
    'name' => 'Name',
    'name__placeholder' => 'Enter name here...',
    'description' => 'Description',
    'size' => 'Size',
    'size__placeholder' => 'Enter size here...',
    'meta_data' => 'Meta Data',
    'meta_data__placeholder' => 'Enter meta data here...',
    'user_id' => 'User',
    'user_id__placeholder' => 'Select user',
    'parent' => 'Parent',
    'parent__placeholder' => 'Enter parent here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing media archives.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the media archive property name where the value is the assigned value to the retrieved media archive.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved media archive.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of media archives per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved media archive.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new media archive.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing media archive.',
    ...
    'show_route_description' => 'Retrieve existsing media archive.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the media archive to retrieve',
    'destroy_route_description' => 'Delete existsing media archive.',
    ...
    'the_id_of_model_to_delete' => 'The id of the media archive to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete media archives.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the media archive.',
    ...
    'the_requested_model_does_not_exists' => 'The requested media archive does not exists.',
    ...
    'create' => 'Create New Media Archive',
    'delete' => 'Delete Media Archive',
    'edit' => 'Edit Media Archive',
    'show' => 'Show Media Archive',
    'show_all' => 'Show All Media Archive',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Media Archive.',
    'none_available' => 'No Media Archives Available.',
    'model_plural' => 'Media Archives',
    'model_was_added' => 'Media Archive was successfully added.',
    'model_was_retrieved' => 'Media Archive was successfully retrieved.',
    'models_were_retrieved' => 'Media Archives were successfully retrieved.',
    'model_was_updated' => 'Media Archive was successfully updated.',
    'model_was_deleted' => 'Media Archive was successfully deleted.',
    ...
    'model_id_camel_case' => 'media archiveId',
