...
return [
    ...
    'index_route_description' => 'Retrieve existing student grade reasons.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the student grade reason property name where the value is the assigned value to the retrieved student grade reason.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved student grade reason.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of student grade reasons per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved student grade reason.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new student grade reason.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing student grade reason.',
    ...
    'show_route_description' => 'Retrieve existsing student grade reason.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the student grade reason to retrieve',
    'destroy_route_description' => 'Delete existsing student grade reason.',
    ...
    'the_id_of_model_to_delete' => 'The id of the student grade reason to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete student grade reasons.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the student grade reason.',
    ...
    'the_requested_model_does_not_exists' => 'The requested student grade reason does not exists.',
    ...
    'create' => 'Create New Student Grade Reason',
    'delete' => 'Delete Student Grade Reason',
    'edit' => 'Edit Student Grade Reason',
    'show' => 'Show Student Grade Reason',
    'show_all' => 'Show All Student Grade Reason',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Student Grade Reason.',
    'none_available' => 'No Student Grade Reasons Available.',
    'model_plural' => 'Student Grade Reasons',
    'model_was_added' => 'Student Grade Reason was successfully added.',
    'model_was_retrieved' => 'Student Grade Reason was successfully retrieved.',
    'models_were_retrieved' => 'Student Grade Reasons were successfully retrieved.',
    'model_was_updated' => 'Student Grade Reason was successfully updated.',
    'model_was_deleted' => 'Student Grade Reason was successfully deleted.',
    ...
    'model_id_camel_case' => 'student grade reasonId',
