...
return [
    ...
    'storage_category_id__placeholder' => 'Enter storage category here...',
    'storage_type_id' => 'Storage Type',
    'storage_type_id__placeholder' => 'Enter storage type here...',
    'name' => 'Name',
    'name__placeholder' => 'Enter name here...',
    'serial_no' => 'Serial No',
    'serial_no__placeholder' => 'Enter serial no here...',
    'length' => 'Length',
    'length__placeholder' => 'Enter length here...',
    'width' => 'Width',
    'width__placeholder' => 'Enter width here...',
    'Height' => 'Height',
    'Height__placeholder' => 'Enter height here...',
    'space_remaining' => 'Space Remaining',
    'space_remaining__placeholder' => 'Enter space remaining here...',
    'space_remaining_percentage' => 'Space Remaining Percentage',
    'space_remaining_percentage__placeholder' => 'Enter space remaining percentage here...',
    'user_id' => 'User',
    ...
    'index_route_description' => 'Retrieve existing storages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the storage property name where the value is the assigned value to the retrieved storage.',
    ...
    'show_route_description' => 'Retrieve existsing storage.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the storage to retrieve',
    'destroy_route_description' => 'Delete existsing storage.',
    ...
    'the_id_of_model_to_delete' => 'The id of the storage to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete storages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the storage.',
    ...
    'the_requested_model_does_not_exists' => 'The requested storage does not exists.',
    ...
    'edit' => 'Edit Storage',
    'show' => 'Show Storage',
    'show_all' => 'Show All Storage',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Storage.',
    'none_available' => 'No Storages Available.',
    'model_plural' => 'Storages',
    'model_was_added' => 'Storage was successfully added.',
    'model_was_retrieved' => 'Storage was successfully retrieved.',
    'models_were_retrieved' => 'Storages were successfully retrieved.',
    'model_was_updated' => 'Storage was successfully updated.',
    'model_was_deleted' => 'Storage was successfully deleted.',
