...
return [
    ...
    'index_route_description' => 'Retrieve existing user chronic diseases.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user chronic disease property name where the value is the assigned value to the retrieved user chronic disease.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user chronic disease.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user chronic diseases per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user chronic disease.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user chronic disease.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user chronic disease.',
    ...
    'show_route_description' => 'Retrieve existsing user chronic disease.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user chronic disease to retrieve',
    'destroy_route_description' => 'Delete existsing user chronic disease.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user chronic disease to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user chronic diseases.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user chronic disease.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user chronic disease does not exists.',
    ...
    'create' => 'Create New User Chronic Disease',
    'delete' => 'Delete User Chronic Disease',
    'edit' => 'Edit User Chronic Disease',
    'show' => 'Show User Chronic Disease',
    'show_all' => 'Show All User Chronic Disease',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Chronic Disease.',
    'none_available' => 'No User Chronic Diseases Available.',
    'model_plural' => 'User Chronic Diseases',
    'model_was_added' => 'User Chronic Disease was successfully added.',
    'model_was_retrieved' => 'User Chronic Disease was successfully retrieved.',
    'models_were_retrieved' => 'User Chronic Diseases were successfully retrieved.',
    'model_was_updated' => 'User Chronic Disease was successfully updated.',
    'model_was_deleted' => 'User Chronic Disease was successfully deleted.',
    ...
    'model_id_camel_case' => 'user chronic diseaseId',
