...
return [
    ...
    'application_type_id__placeholder' => 'Select application type',
    'name' => 'Name',
    'name__placeholder' => 'Enter name here...',
    'description' => 'Description',
    'numerical_representation' => 'Numerical Representation',
    'numerical_representation__placeholder' => 'Enter numerical representation here...',
    ...
    'index_route_description' => 'Retrieve existing posts.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the post property name where the value is the assigned value to the retrieved post.',
    ...
    'show_route_description' => 'Retrieve existsing post.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the post to retrieve',
    'destroy_route_description' => 'Delete existsing post.',
    ...
    'the_id_of_model_to_delete' => 'The id of the post to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete posts.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the post.',
    ...
    'the_requested_model_does_not_exists' => 'The requested post does not exists.',
    ...
    'edit' => 'Edit Post',
    'show' => 'Show Post',
    'show_all' => 'Show All Post',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Post.',
    'none_available' => 'No Posts Available.',
    'model_plural' => 'Posts',
    'model_was_added' => 'Post was successfully added.',
    'model_was_retrieved' => 'Post was successfully retrieved.',
    'models_were_retrieved' => 'Posts were successfully retrieved.',
    'model_was_updated' => 'Post was successfully updated.',
    'model_was_deleted' => 'Post was successfully deleted.',
