...
return [
    ...
    'duration_in_hours__placeholder' => 'Enter duration in hours here...',
    'date' => 'Date',
    ...
    'index_route_description' => 'Retrieve existing inventory storages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the inventory storage property name where the value is the assigned value to the retrieved inventory storage.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved inventory storage.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of inventory storages per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved inventory storage.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new inventory storage.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing inventory storage.',
    ...
    'show_route_description' => 'Retrieve existsing inventory storage.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the inventory storage to retrieve',
    'destroy_route_description' => 'Delete existsing inventory storage.',
    ...
    'the_id_of_model_to_delete' => 'The id of the inventory storage to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete inventory storages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the inventory storage.',
    ...
    'the_requested_model_does_not_exists' => 'The requested inventory storage does not exists.',
    ...
    'create' => 'Create New Inventory Storage',
    'delete' => 'Delete Inventory Storage',
    'edit' => 'Edit Inventory Storage',
    'show' => 'Show Inventory Storage',
    'show_all' => 'Show All Inventory Storage',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Inventory Storage.',
    'none_available' => 'No Inventory Storages Available.',
    'model_plural' => 'Inventory Storages',
    'model_was_added' => 'Inventory Storage was successfully added.',
    'model_was_retrieved' => 'Inventory Storage was successfully retrieved.',
    'models_were_retrieved' => 'Inventory Storages were successfully retrieved.',
    'model_was_updated' => 'Inventory Storage was successfully updated.',
    'model_was_deleted' => 'Inventory Storage was successfully deleted.',
    ...
    'model_id_camel_case' => 'inventory storageId',
