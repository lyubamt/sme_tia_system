...
return [
    ...
    'payee_name__placeholder' => 'Enter payee name here...',
    'payee_number' => 'Payee Number',
    'payee_number__placeholder' => 'Enter payee number here...',
    'payee_address' => 'Payee Address',
    'payee_address__placeholder' => 'Enter payee address here...',
    'payment_reason' => 'Payment Reason',
    'payment_reason__placeholder' => 'Enter payment reason here...',
    'amount' => 'Amount',
    'amount__placeholder' => 'Enter amount here...',
    'condolence_id' => 'Condolence',
    'condolence_id__placeholder' => 'Select condolence',
    ...
    'index_route_description' => 'Retrieve existing payment vouchers.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the payment voucher property name where the value is the assigned value to the retrieved payment voucher.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved payment voucher.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of payment vouchers per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved payment voucher.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new payment voucher.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing payment voucher.',
    ...
    'show_route_description' => 'Retrieve existsing payment voucher.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the payment voucher to retrieve',
    'destroy_route_description' => 'Delete existsing payment voucher.',
    ...
    'the_id_of_model_to_delete' => 'The id of the payment voucher to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete payment vouchers.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the payment voucher.',
    ...
    'the_requested_model_does_not_exists' => 'The requested payment voucher does not exists.',
    ...
    'create' => 'Create New Payment Voucher',
    'delete' => 'Delete Payment Voucher',
    'edit' => 'Edit Payment Voucher',
    'show' => 'Show Payment Voucher',
    'show_all' => 'Show All Payment Voucher',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Payment Voucher.',
    'none_available' => 'No Payment Vouchers Available.',
    'model_plural' => 'Payment Vouchers',
    'model_was_added' => 'Payment Voucher was successfully added.',
    'model_was_retrieved' => 'Payment Voucher was successfully retrieved.',
    'models_were_retrieved' => 'Payment Vouchers were successfully retrieved.',
    'model_was_updated' => 'Payment Voucher was successfully updated.',
    'model_was_deleted' => 'Payment Voucher was successfully deleted.',
    ...
    'model_id_camel_case' => 'payment voucherId',
