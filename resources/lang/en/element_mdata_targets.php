...
return [
    ...
    'time_duration_id' => 'Time Duration',
    'time_duration_id__placeholder' => 'Select time duration',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing element mdata targets.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the element mdata target property name where the value is the assigned value to the retrieved element mdata target.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved element mdata target.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of element mdata targets per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved element mdata target.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new element mdata target.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing element mdata target.',
    ...
    'show_route_description' => 'Retrieve existsing element mdata target.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the element mdata target to retrieve',
    'destroy_route_description' => 'Delete existsing element mdata target.',
    ...
    'the_id_of_model_to_delete' => 'The id of the element mdata target to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete element mdata targets.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the element mdata target.',
    ...
    'the_requested_model_does_not_exists' => 'The requested element mdata target does not exists.',
    ...
    'create' => 'Create New Element Mdata Target',
    'delete' => 'Delete Element Mdata Target',
    'edit' => 'Edit Element Mdata Target',
    'show' => 'Show Element Mdata Target',
    'show_all' => 'Show All Element Mdata Target',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Element Mdata Target.',
    'none_available' => 'No Element Mdata Targets Available.',
    'model_plural' => 'Element Mdata Targets',
    'model_was_added' => 'Element Mdata Target was successfully added.',
    'model_was_retrieved' => 'Element Mdata Target was successfully retrieved.',
    'models_were_retrieved' => 'Element Mdata Targets were successfully retrieved.',
    'model_was_updated' => 'Element Mdata Target was successfully updated.',
    'model_was_deleted' => 'Element Mdata Target was successfully deleted.',
    ...
    'model_id_camel_case' => 'element mdata targetId',
