...
return [
    ...
    'cost_per_kilo_hour' => 'Cost Per Kilo Hour',
    'cost_per_kilo_hour__placeholder' => 'Enter cost per kilo hour here...',
    ...
    'index_route_description' => 'Retrieve existing storage costs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the storage cost property name where the value is the assigned value to the retrieved storage cost.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved storage cost.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of storage costs per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved storage cost.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new storage cost.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing storage cost.',
    ...
    'show_route_description' => 'Retrieve existsing storage cost.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the storage cost to retrieve',
    'destroy_route_description' => 'Delete existsing storage cost.',
    ...
    'the_id_of_model_to_delete' => 'The id of the storage cost to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete storage costs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the storage cost.',
    ...
    'the_requested_model_does_not_exists' => 'The requested storage cost does not exists.',
    ...
    'create' => 'Create New Storage Cost',
    'delete' => 'Delete Storage Cost',
    'edit' => 'Edit Storage Cost',
    'show' => 'Show Storage Cost',
    'show_all' => 'Show All Storage Cost',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Storage Cost.',
    'none_available' => 'No Storage Costs Available.',
    'model_plural' => 'Storage Costs',
    'model_was_added' => 'Storage Cost was successfully added.',
    'model_was_retrieved' => 'Storage Cost was successfully retrieved.',
    'models_were_retrieved' => 'Storage Costs were successfully retrieved.',
    'model_was_updated' => 'Storage Cost was successfully updated.',
    'model_was_deleted' => 'Storage Cost was successfully deleted.',
    ...
    'model_id_camel_case' => 'storage costId',
