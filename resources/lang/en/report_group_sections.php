...
return [
    ...
    'report_group_id__placeholder' => 'Select report group',
    'name' => 'Name',
    'name__placeholder' => 'Enter name here...',
    'description' => 'Description',
    'direction' => 'Direction',
    'direction__placeholder' => 'Enter direction here...',
    'placement_order' => 'Placement Order',
    'placement_order__placeholder' => 'Enter placement order here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing report group sections.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the report group section property name where the value is the assigned value to the retrieved report group section.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved report group section.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of report group sections per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved report group section.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new report group section.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing report group section.',
    ...
    'show_route_description' => 'Retrieve existsing report group section.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the report group section to retrieve',
    'destroy_route_description' => 'Delete existsing report group section.',
    ...
    'the_id_of_model_to_delete' => 'The id of the report group section to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete report group sections.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the report group section.',
    ...
    'the_requested_model_does_not_exists' => 'The requested report group section does not exists.',
    ...
    'create' => 'Create New Report Group Section',
    'delete' => 'Delete Report Group Section',
    'edit' => 'Edit Report Group Section',
    'show' => 'Show Report Group Section',
    'show_all' => 'Show All Report Group Section',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Report Group Section.',
    'none_available' => 'No Report Group Sections Available.',
    'model_plural' => 'Report Group Sections',
    'model_was_added' => 'Report Group Section was successfully added.',
    'model_was_retrieved' => 'Report Group Section was successfully retrieved.',
    'models_were_retrieved' => 'Report Group Sections were successfully retrieved.',
    'model_was_updated' => 'Report Group Section was successfully updated.',
    'model_was_deleted' => 'Report Group Section was successfully deleted.',
    ...
    'model_id_camel_case' => 'report group sectionId',
