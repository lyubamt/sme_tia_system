...
return [
    ...
    'index_route_description' => 'Retrieve existing saccos transaction methods.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the saccos transaction method property name where the value is the assigned value to the retrieved saccos transaction method.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved saccos transaction method.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of saccos transaction methods per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved saccos transaction method.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new saccos transaction method.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing saccos transaction method.',
    ...
    'show_route_description' => 'Retrieve existsing saccos transaction method.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the saccos transaction method to retrieve',
    'destroy_route_description' => 'Delete existsing saccos transaction method.',
    ...
    'the_id_of_model_to_delete' => 'The id of the saccos transaction method to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete saccos transaction methods.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the saccos transaction method.',
    ...
    'the_requested_model_does_not_exists' => 'The requested saccos transaction method does not exists.',
    ...
    'create' => 'Create New Saccos Transaction Method',
    'delete' => 'Delete Saccos Transaction Method',
    'edit' => 'Edit Saccos Transaction Method',
    'show' => 'Show Saccos Transaction Method',
    'show_all' => 'Show All Saccos Transaction Method',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Saccos Transaction Method.',
    'none_available' => 'No Saccos Transaction Methods Available.',
    'model_plural' => 'Saccos Transaction Methods',
    'model_was_added' => 'Saccos Transaction Method was successfully added.',
    'model_was_retrieved' => 'Saccos Transaction Method was successfully retrieved.',
    'models_were_retrieved' => 'Saccos Transaction Methods were successfully retrieved.',
    'model_was_updated' => 'Saccos Transaction Method was successfully updated.',
    'model_was_deleted' => 'Saccos Transaction Method was successfully deleted.',
    ...
    'model_id_camel_case' => 'saccos transaction methodId',
