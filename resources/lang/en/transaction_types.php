...
return [
    ...
    'index_route_description' => 'Retrieve existing transaction types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the transaction type property name where the value is the assigned value to the retrieved transaction type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved transaction type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of transaction types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved transaction type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new transaction type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing transaction type.',
    ...
    'show_route_description' => 'Retrieve existsing transaction type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the transaction type to retrieve',
    'destroy_route_description' => 'Delete existsing transaction type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the transaction type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete transaction types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the transaction type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested transaction type does not exists.',
    ...
    'create' => 'Create New Transaction Type',
    'delete' => 'Delete Transaction Type',
    'edit' => 'Edit Transaction Type',
    'show' => 'Show Transaction Type',
    'show_all' => 'Show All Transaction Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Transaction Type.',
    'none_available' => 'No Transaction Types Available.',
    'model_plural' => 'Transaction Types',
    'model_was_added' => 'Transaction Type was successfully added.',
    'model_was_retrieved' => 'Transaction Type was successfully retrieved.',
    'models_were_retrieved' => 'Transaction Types were successfully retrieved.',
    'model_was_updated' => 'Transaction Type was successfully updated.',
    'model_was_deleted' => 'Transaction Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'transaction typeId',
