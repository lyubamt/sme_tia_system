...
return [
    ...
    'index_route_description' => 'Retrieve existing user skills.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user skill property name where the value is the assigned value to the retrieved user skill.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user skill.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user skills per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user skill.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user skill.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user skill.',
    ...
    'show_route_description' => 'Retrieve existsing user skill.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user skill to retrieve',
    'destroy_route_description' => 'Delete existsing user skill.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user skill to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user skills.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user skill.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user skill does not exists.',
    ...
    'create' => 'Create New User Skill',
    'delete' => 'Delete User Skill',
    'edit' => 'Edit User Skill',
    'show' => 'Show User Skill',
    'show_all' => 'Show All User Skill',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Skill.',
    'none_available' => 'No User Skills Available.',
    'model_plural' => 'User Skills',
    'model_was_added' => 'User Skill was successfully added.',
    'model_was_retrieved' => 'User Skill was successfully retrieved.',
    'models_were_retrieved' => 'User Skills were successfully retrieved.',
    'model_was_updated' => 'User Skill was successfully updated.',
    'model_was_deleted' => 'User Skill was successfully deleted.',
    ...
    'model_id_camel_case' => 'user skillId',
