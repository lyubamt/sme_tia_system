...
return [
    ...
    'index_route_description' => 'Retrieve existing media categories.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the media category property name where the value is the assigned value to the retrieved media category.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved media category.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of media categories per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved media category.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new media category.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing media category.',
    ...
    'show_route_description' => 'Retrieve existsing media category.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the media category to retrieve',
    'destroy_route_description' => 'Delete existsing media category.',
    ...
    'the_id_of_model_to_delete' => 'The id of the media category to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete media categories.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the media category.',
    ...
    'the_requested_model_does_not_exists' => 'The requested media category does not exists.',
    ...
    'create' => 'Create New Media Category',
    'delete' => 'Delete Media Category',
    'edit' => 'Edit Media Category',
    'show' => 'Show Media Category',
    'show_all' => 'Show All Media Category',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Media Category.',
    'none_available' => 'No Media Categories Available.',
    'model_plural' => 'Media Categories',
    'model_was_added' => 'Media Category was successfully added.',
    'model_was_retrieved' => 'Media Category was successfully retrieved.',
    'models_were_retrieved' => 'Media Categories were successfully retrieved.',
    'model_was_updated' => 'Media Category was successfully updated.',
    'model_was_deleted' => 'Media Category was successfully deleted.',
    ...
    'model_id_camel_case' => 'media categoryId',
