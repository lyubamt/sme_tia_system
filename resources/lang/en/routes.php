...
return [
    ...
    'route_type_id' => 'Route Type',
    'route_type_id__placeholder' => 'Select route type',
    'from_place' => 'From Place',
    'from_place__placeholder' => 'Enter from place here...',
    'from_coords' => 'From Coords',
    'from_coords__placeholder' => 'Enter from coords here...',
    'to_place' => 'To Place',
    'to_place__placeholder' => 'Enter to place here...',
    'to_coords' => 'To Coords',
    'to_coords__placeholder' => 'Enter to coords here...',
    'distance' => 'Distance',
    ...
    'index_route_description' => 'Retrieve existing routes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the route property name where the value is the assigned value to the retrieved route.',
    ...
    'show_route_description' => 'Retrieve existsing route.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the route to retrieve',
    'destroy_route_description' => 'Delete existsing route.',
    ...
    'the_id_of_model_to_delete' => 'The id of the route to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete routes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the route.',
    ...
    'the_requested_model_does_not_exists' => 'The requested route does not exists.',
    ...
    'edit' => 'Edit Route',
    'show' => 'Show Route',
    'show_all' => 'Show All Route',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Route.',
    'none_available' => 'No Routes Available.',
    'model_plural' => 'Routes',
    'model_was_added' => 'Route was successfully added.',
    'model_was_retrieved' => 'Route was successfully retrieved.',
    'models_were_retrieved' => 'Routes were successfully retrieved.',
    'model_was_updated' => 'Route was successfully updated.',
    'model_was_deleted' => 'Route was successfully deleted.',
