...
return [
    ...
    'station_element_id' => 'Station Element',
    'station_element_id__placeholder' => 'Select station element',
    'date' => 'Date',
    ...
    'index_route_description' => 'Retrieve existing station climatic datas.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the station climatic data property name where the value is the assigned value to the retrieved station climatic data.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved station climatic data.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of station climatic datas per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved station climatic data.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new station climatic data.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing station climatic data.',
    ...
    'show_route_description' => 'Retrieve existsing station climatic data.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the station climatic data to retrieve',
    'destroy_route_description' => 'Delete existsing station climatic data.',
    ...
    'the_id_of_model_to_delete' => 'The id of the station climatic data to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete station climatic datas.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the station climatic data.',
    ...
    'the_requested_model_does_not_exists' => 'The requested station climatic data does not exists.',
    ...
    'create' => 'Create New Station Climatic Data',
    'delete' => 'Delete Station Climatic Data',
    'edit' => 'Edit Station Climatic Data',
    'show' => 'Show Station Climatic Data',
    'show_all' => 'Show All Station Climatic Data',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Station Climatic Data.',
    'none_available' => 'No Station Climatic Datas Available.',
    'model_plural' => 'Station Climatic Datas',
    'model_was_added' => 'Station Climatic Data was successfully added.',
    'model_was_retrieved' => 'Station Climatic Data was successfully retrieved.',
    'models_were_retrieved' => 'Station Climatic Datas were successfully retrieved.',
    'model_was_updated' => 'Station Climatic Data was successfully updated.',
    'model_was_deleted' => 'Station Climatic Data was successfully deleted.',
    ...
    'model_id_camel_case' => 'station climatic dataId',
