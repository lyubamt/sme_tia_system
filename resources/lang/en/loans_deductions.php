...
return [
    ...
    'index_route_description' => 'Retrieve existing loans deductions.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the loans deduction property name where the value is the assigned value to the retrieved loans deduction.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved loans deduction.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of loans deductions per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved loans deduction.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new loans deduction.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing loans deduction.',
    ...
    'show_route_description' => 'Retrieve existsing loans deduction.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the loans deduction to retrieve',
    'destroy_route_description' => 'Delete existsing loans deduction.',
    ...
    'the_id_of_model_to_delete' => 'The id of the loans deduction to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete loans deductions.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the loans deduction.',
    ...
    'the_requested_model_does_not_exists' => 'The requested loans deduction does not exists.',
    ...
    'create' => 'Create New Loans Deduction',
    'delete' => 'Delete Loans Deduction',
    'edit' => 'Edit Loans Deduction',
    'show' => 'Show Loans Deduction',
    'show_all' => 'Show All Loans Deduction',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Loans Deduction.',
    'none_available' => 'No Loans Deductions Available.',
    'model_plural' => 'Loans Deductions',
    'model_was_added' => 'Loans Deduction was successfully added.',
    'model_was_retrieved' => 'Loans Deduction was successfully retrieved.',
    'models_were_retrieved' => 'Loans Deductions were successfully retrieved.',
    'model_was_updated' => 'Loans Deduction was successfully updated.',
    'model_was_deleted' => 'Loans Deduction was successfully deleted.',
    ...
    'model_id_camel_case' => 'loans deductionId',
