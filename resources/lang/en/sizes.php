...
return [
    ...
    'total' => 'Total',
    'total__placeholder' => 'Enter total here...',
    ...
    'index_route_description' => 'Retrieve existing sizes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the size property name where the value is the assigned value to the retrieved size.',
    ...
    'show_route_description' => 'Retrieve existsing size.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the size to retrieve',
    'destroy_route_description' => 'Delete existsing size.',
    ...
    'the_id_of_model_to_delete' => 'The id of the size to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete sizes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the size.',
    ...
    'the_requested_model_does_not_exists' => 'The requested size does not exists.',
    ...
    'edit' => 'Edit Size',
    'show' => 'Show Size',
    'show_all' => 'Show All Size',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Size.',
    'none_available' => 'No Sizes Available.',
    'model_plural' => 'Sizes',
    'model_was_added' => 'Size was successfully added.',
    'model_was_retrieved' => 'Size was successfully retrieved.',
    'models_were_retrieved' => 'Sizes were successfully retrieved.',
    'model_was_updated' => 'Size was successfully updated.',
    'model_was_deleted' => 'Size was successfully deleted.',
