...
return [
    ...
    'time_scheme_type_id' => 'Time Scheme Type',
    'time_scheme_type_id__placeholder' => 'Select time scheme type',
    ...
    'index_route_description' => 'Retrieve existing time schemes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the time scheme property name where the value is the assigned value to the retrieved time scheme.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved time scheme.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of time schemes per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved time scheme.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new time scheme.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing time scheme.',
    ...
    'show_route_description' => 'Retrieve existsing time scheme.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the time scheme to retrieve',
    'destroy_route_description' => 'Delete existsing time scheme.',
    ...
    'the_id_of_model_to_delete' => 'The id of the time scheme to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete time schemes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the time scheme.',
    ...
    'the_requested_model_does_not_exists' => 'The requested time scheme does not exists.',
    ...
    'create' => 'Create New Time Scheme',
    'delete' => 'Delete Time Scheme',
    'edit' => 'Edit Time Scheme',
    'show' => 'Show Time Scheme',
    'show_all' => 'Show All Time Scheme',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Time Scheme.',
    'none_available' => 'No Time Schemes Available.',
    'model_plural' => 'Time Schemes',
    'model_was_added' => 'Time Scheme was successfully added.',
    'model_was_retrieved' => 'Time Scheme was successfully retrieved.',
    'models_were_retrieved' => 'Time Schemes were successfully retrieved.',
    'model_was_updated' => 'Time Scheme was successfully updated.',
    'model_was_deleted' => 'Time Scheme was successfully deleted.',
    ...
    'model_id_camel_case' => 'time schemeId',
