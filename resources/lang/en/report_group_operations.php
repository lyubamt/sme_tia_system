...
return [
    ...
    'first_operand__placeholder' => 'Enter first operand here...',
    'operator' => 'Operator',
    'operator__placeholder' => 'Enter operator here...',
    'second_operand' => 'Second Operand',
    'second_operand__placeholder' => 'Enter second operand here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing report group operations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the report group operation property name where the value is the assigned value to the retrieved report group operation.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved report group operation.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of report group operations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved report group operation.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new report group operation.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing report group operation.',
    ...
    'show_route_description' => 'Retrieve existsing report group operation.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the report group operation to retrieve',
    'destroy_route_description' => 'Delete existsing report group operation.',
    ...
    'the_id_of_model_to_delete' => 'The id of the report group operation to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete report group operations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the report group operation.',
    ...
    'the_requested_model_does_not_exists' => 'The requested report group operation does not exists.',
    ...
    'create' => 'Create New Report Group Operation',
    'delete' => 'Delete Report Group Operation',
    'edit' => 'Edit Report Group Operation',
    'show' => 'Show Report Group Operation',
    'show_all' => 'Show All Report Group Operation',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Report Group Operation.',
    'none_available' => 'No Report Group Operations Available.',
    'model_plural' => 'Report Group Operations',
    'model_was_added' => 'Report Group Operation was successfully added.',
    'model_was_retrieved' => 'Report Group Operation was successfully retrieved.',
    'models_were_retrieved' => 'Report Group Operations were successfully retrieved.',
    'model_was_updated' => 'Report Group Operation was successfully updated.',
    'model_was_deleted' => 'Report Group Operation was successfully deleted.',
    ...
    'model_id_camel_case' => 'report group operationId',
