...
return [
    ...
    'index_route_description' => 'Retrieve existing user work experiences.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user work experience property name where the value is the assigned value to the retrieved user work experience.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user work experience.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user work experiences per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user work experience.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user work experience.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user work experience.',
    ...
    'show_route_description' => 'Retrieve existsing user work experience.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user work experience to retrieve',
    'destroy_route_description' => 'Delete existsing user work experience.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user work experience to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user work experiences.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user work experience.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user work experience does not exists.',
    ...
    'create' => 'Create New User Work Experience',
    'delete' => 'Delete User Work Experience',
    'edit' => 'Edit User Work Experience',
    'show' => 'Show User Work Experience',
    'show_all' => 'Show All User Work Experience',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Work Experience.',
    'none_available' => 'No User Work Experiences Available.',
    'model_plural' => 'User Work Experiences',
    'model_was_added' => 'User Work Experience was successfully added.',
    'model_was_retrieved' => 'User Work Experience was successfully retrieved.',
    'models_were_retrieved' => 'User Work Experiences were successfully retrieved.',
    'model_was_updated' => 'User Work Experience was successfully updated.',
    'model_was_deleted' => 'User Work Experience was successfully deleted.',
    ...
    'model_id_camel_case' => 'user work experienceId',
