...
return [
    ...
    'body_part_id__placeholder' => 'Select body part',
    ...
    'index_route_description' => 'Retrieve existing user disabilities.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user disability property name where the value is the assigned value to the retrieved user disability.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user disability.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user disabilities per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user disability.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user disability.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user disability.',
    ...
    'show_route_description' => 'Retrieve existsing user disability.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user disability to retrieve',
    'destroy_route_description' => 'Delete existsing user disability.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user disability to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user disabilities.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user disability.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user disability does not exists.',
    ...
    'create' => 'Create New User Disability',
    'delete' => 'Delete User Disability',
    'edit' => 'Edit User Disability',
    'show' => 'Show User Disability',
    'show_all' => 'Show All User Disability',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Disability.',
    'none_available' => 'No User Disabilities Available.',
    'model_plural' => 'User Disabilities',
    'model_was_added' => 'User Disability was successfully added.',
    'model_was_retrieved' => 'User Disability was successfully retrieved.',
    'models_were_retrieved' => 'User Disabilities were successfully retrieved.',
    'model_was_updated' => 'User Disability was successfully updated.',
    'model_was_deleted' => 'User Disability was successfully deleted.',
    ...
    'model_id_camel_case' => 'user disabilityId',
