...
return [
    ...
    'form_type' => 'Form Type',
    'form_type__placeholder' => 'Enter form type here...',
    'headers' => 'Headers',
    'headers__placeholder' => 'Enter headers here...',
    'columns' => 'Columns',
    'columns__placeholder' => 'Enter columns here...',
    'columns_selections' => 'Columns Selections',
    'columns_selections__placeholder' => 'Enter columns selections here...',
    'rows' => 'Rows',
    'rows__placeholder' => 'Enter rows here...',
    'rows_selections' => 'Rows Selections',
    'rows_selections__placeholder' => 'Enter rows selections here...',
    ...
    'index_route_description' => 'Retrieve existing kef forms.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the kef form property name where the value is the assigned value to the retrieved kef form.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved kef form.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of kef forms per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved kef form.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new kef form.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing kef form.',
    ...
    'show_route_description' => 'Retrieve existsing kef form.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the kef form to retrieve',
    'destroy_route_description' => 'Delete existsing kef form.',
    ...
    'the_id_of_model_to_delete' => 'The id of the kef form to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete kef forms.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the kef form.',
    ...
    'the_requested_model_does_not_exists' => 'The requested kef form does not exists.',
    ...
    'create' => 'Create New Kef Form',
    'delete' => 'Delete Kef Form',
    'edit' => 'Edit Kef Form',
    'show' => 'Show Kef Form',
    'show_all' => 'Show All Kef Form',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Kef Form.',
    'none_available' => 'No Kef Forms Available.',
    'model_plural' => 'Kef Forms',
    'model_was_added' => 'Kef Form was successfully added.',
    'model_was_retrieved' => 'Kef Form was successfully retrieved.',
    'models_were_retrieved' => 'Kef Forms were successfully retrieved.',
    'model_was_updated' => 'Kef Form was successfully updated.',
    'model_was_deleted' => 'Kef Form was successfully deleted.',
    ...
    'model_id_camel_case' => 'kef formId',
