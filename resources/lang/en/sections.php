...
return [
    ...
    'index_route_description' => 'Retrieve existing sections.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the section property name where the value is the assigned value to the retrieved section.',
    ...
    'show_route_description' => 'Retrieve existsing section.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the section to retrieve',
    'destroy_route_description' => 'Delete existsing section.',
    ...
    'the_id_of_model_to_delete' => 'The id of the section to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete sections.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the section.',
    ...
    'the_requested_model_does_not_exists' => 'The requested section does not exists.',
    ...
    'edit' => 'Edit Section',
    'show' => 'Show Section',
    'show_all' => 'Show All Section',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Section.',
    'none_available' => 'No Sections Available.',
    'model_plural' => 'Sections',
    'model_was_added' => 'Section was successfully added.',
    'model_was_retrieved' => 'Section was successfully retrieved.',
    'models_were_retrieved' => 'Sections were successfully retrieved.',
    'model_was_updated' => 'Section was successfully updated.',
    'model_was_deleted' => 'Section was successfully deleted.',
