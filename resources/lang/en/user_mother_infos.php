...
return [
    ...
    'index_route_description' => 'Retrieve existing user mother infos.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user mother info property name where the value is the assigned value to the retrieved user mother info.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user mother info.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user mother infos per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user mother info.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user mother info.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user mother info.',
    ...
    'show_route_description' => 'Retrieve existsing user mother info.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user mother info to retrieve',
    'destroy_route_description' => 'Delete existsing user mother info.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user mother info to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user mother infos.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user mother info.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user mother info does not exists.',
    ...
    'create' => 'Create New User Mother Info',
    'delete' => 'Delete User Mother Info',
    'edit' => 'Edit User Mother Info',
    'show' => 'Show User Mother Info',
    'show_all' => 'Show All User Mother Info',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Mother Info.',
    'none_available' => 'No User Mother Infos Available.',
    'model_plural' => 'User Mother Infos',
    'model_was_added' => 'User Mother Info was successfully added.',
    'model_was_retrieved' => 'User Mother Info was successfully retrieved.',
    'models_were_retrieved' => 'User Mother Infos were successfully retrieved.',
    'model_was_updated' => 'User Mother Info was successfully updated.',
    'model_was_deleted' => 'User Mother Info was successfully deleted.',
    ...
    'model_id_camel_case' => 'user mother infoId',
