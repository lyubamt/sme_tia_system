...
return [
    ...
    'index_route_description' => 'Retrieve existing saccos transaction reasons.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the saccos transaction reason property name where the value is the assigned value to the retrieved saccos transaction reason.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved saccos transaction reason.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of saccos transaction reasons per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved saccos transaction reason.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new saccos transaction reason.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing saccos transaction reason.',
    ...
    'show_route_description' => 'Retrieve existsing saccos transaction reason.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the saccos transaction reason to retrieve',
    'destroy_route_description' => 'Delete existsing saccos transaction reason.',
    ...
    'the_id_of_model_to_delete' => 'The id of the saccos transaction reason to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete saccos transaction reasons.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the saccos transaction reason.',
    ...
    'the_requested_model_does_not_exists' => 'The requested saccos transaction reason does not exists.',
    ...
    'create' => 'Create New Saccos Transaction Reason',
    'delete' => 'Delete Saccos Transaction Reason',
    'edit' => 'Edit Saccos Transaction Reason',
    'show' => 'Show Saccos Transaction Reason',
    'show_all' => 'Show All Saccos Transaction Reason',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Saccos Transaction Reason.',
    'none_available' => 'No Saccos Transaction Reasons Available.',
    'model_plural' => 'Saccos Transaction Reasons',
    'model_was_added' => 'Saccos Transaction Reason was successfully added.',
    'model_was_retrieved' => 'Saccos Transaction Reason was successfully retrieved.',
    'models_were_retrieved' => 'Saccos Transaction Reasons were successfully retrieved.',
    'model_was_updated' => 'Saccos Transaction Reason was successfully updated.',
    'model_was_deleted' => 'Saccos Transaction Reason was successfully deleted.',
    ...
    'model_id_camel_case' => 'saccos transaction reasonId',
