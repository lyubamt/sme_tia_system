...
return [
    ...
    'index_route_description' => 'Retrieve existing user father infos.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user father info property name where the value is the assigned value to the retrieved user father info.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user father info.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user father infos per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user father info.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user father info.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user father info.',
    ...
    'show_route_description' => 'Retrieve existsing user father info.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user father info to retrieve',
    'destroy_route_description' => 'Delete existsing user father info.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user father info to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user father infos.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user father info.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user father info does not exists.',
    ...
    'create' => 'Create New User Father Info',
    'delete' => 'Delete User Father Info',
    'edit' => 'Edit User Father Info',
    'show' => 'Show User Father Info',
    'show_all' => 'Show All User Father Info',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Father Info.',
    'none_available' => 'No User Father Infos Available.',
    'model_plural' => 'User Father Infos',
    'model_was_added' => 'User Father Info was successfully added.',
    'model_was_retrieved' => 'User Father Info was successfully retrieved.',
    'models_were_retrieved' => 'User Father Infos were successfully retrieved.',
    'model_was_updated' => 'User Father Info was successfully updated.',
    'model_was_deleted' => 'User Father Info was successfully deleted.',
    ...
    'model_id_camel_case' => 'user father infoId',
