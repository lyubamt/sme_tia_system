...
return [
    ...
    'index_route_description' => 'Retrieve existing payment reasons.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the payment reason property name where the value is the assigned value to the retrieved payment reason.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved payment reason.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of payment reasons per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved payment reason.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new payment reason.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing payment reason.',
    ...
    'show_route_description' => 'Retrieve existsing payment reason.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the payment reason to retrieve',
    'destroy_route_description' => 'Delete existsing payment reason.',
    ...
    'the_id_of_model_to_delete' => 'The id of the payment reason to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete payment reasons.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the payment reason.',
    ...
    'the_requested_model_does_not_exists' => 'The requested payment reason does not exists.',
    ...
    'create' => 'Create New Payment Reason',
    'delete' => 'Delete Payment Reason',
    'edit' => 'Edit Payment Reason',
    'show' => 'Show Payment Reason',
    'show_all' => 'Show All Payment Reason',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Payment Reason.',
    'none_available' => 'No Payment Reasons Available.',
    'model_plural' => 'Payment Reasons',
    'model_was_added' => 'Payment Reason was successfully added.',
    'model_was_retrieved' => 'Payment Reason was successfully retrieved.',
    'models_were_retrieved' => 'Payment Reasons were successfully retrieved.',
    'model_was_updated' => 'Payment Reason was successfully updated.',
    'model_was_deleted' => 'Payment Reason was successfully deleted.',
    ...
    'model_id_camel_case' => 'payment reasonId',
