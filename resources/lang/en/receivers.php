...
return [
    ...
    'index_route_description' => 'Retrieve existing receivers.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the receiver property name where the value is the assigned value to the retrieved receiver.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved receiver.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of receivers per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved receiver.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new receiver.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing receiver.',
    ...
    'show_route_description' => 'Retrieve existsing receiver.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the receiver to retrieve',
    'destroy_route_description' => 'Delete existsing receiver.',
    ...
    'the_id_of_model_to_delete' => 'The id of the receiver to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete receivers.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the receiver.',
    ...
    'the_requested_model_does_not_exists' => 'The requested receiver does not exists.',
    ...
    'create' => 'Create New Receiver',
    'delete' => 'Delete Receiver',
    'edit' => 'Edit Receiver',
    'show' => 'Show Receiver',
    'show_all' => 'Show All Receiver',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Receiver.',
    'none_available' => 'No Receivers Available.',
    'model_plural' => 'Receivers',
    'model_was_added' => 'Receiver was successfully added.',
    'model_was_retrieved' => 'Receiver was successfully retrieved.',
    'models_were_retrieved' => 'Receivers were successfully retrieved.',
    'model_was_updated' => 'Receiver was successfully updated.',
    'model_was_deleted' => 'Receiver was successfully deleted.',
    ...
    'model_id_camel_case' => 'receiverId',
