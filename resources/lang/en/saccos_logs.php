...
return [
    ...
    'index_route_description' => 'Retrieve existing saccos logs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the saccos log property name where the value is the assigned value to the retrieved saccos log.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved saccos log.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of saccos logs per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved saccos log.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new saccos log.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing saccos log.',
    ...
    'show_route_description' => 'Retrieve existsing saccos log.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the saccos log to retrieve',
    'destroy_route_description' => 'Delete existsing saccos log.',
    ...
    'the_id_of_model_to_delete' => 'The id of the saccos log to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete saccos logs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the saccos log.',
    ...
    'the_requested_model_does_not_exists' => 'The requested saccos log does not exists.',
    ...
    'create' => 'Create New Saccos Log',
    'delete' => 'Delete Saccos Log',
    'edit' => 'Edit Saccos Log',
    'show' => 'Show Saccos Log',
    'show_all' => 'Show All Saccos Log',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Saccos Log.',
    'none_available' => 'No Saccos Logs Available.',
    'model_plural' => 'Saccos Logs',
    'model_was_added' => 'Saccos Log was successfully added.',
    'model_was_retrieved' => 'Saccos Log was successfully retrieved.',
    'models_were_retrieved' => 'Saccos Logs were successfully retrieved.',
    'model_was_updated' => 'Saccos Log was successfully updated.',
    'model_was_deleted' => 'Saccos Log was successfully deleted.',
    ...
    'model_id_camel_case' => 'saccos logId',
