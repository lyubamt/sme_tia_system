...
return [
    ...
    'speed' => 'Speed',
    'speed__placeholder' => 'Enter speed here...',
    'direction' => 'Direction',
    'direction__placeholder' => 'Enter direction here...',
    'ratio' => 'Ratio',
    'ratio__placeholder' => 'Enter ratio here...',
    ...
    'index_route_description' => 'Retrieve existing wind datas.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the wind data property name where the value is the assigned value to the retrieved wind data.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved wind data.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of wind datas per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved wind data.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new wind data.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing wind data.',
    ...
    'show_route_description' => 'Retrieve existsing wind data.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the wind data to retrieve',
    'destroy_route_description' => 'Delete existsing wind data.',
    ...
    'the_id_of_model_to_delete' => 'The id of the wind data to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete wind datas.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the wind data.',
    ...
    'the_requested_model_does_not_exists' => 'The requested wind data does not exists.',
    ...
    'create' => 'Create New Wind Data',
    'delete' => 'Delete Wind Data',
    'edit' => 'Edit Wind Data',
    'show' => 'Show Wind Data',
    'show_all' => 'Show All Wind Data',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Wind Data.',
    'none_available' => 'No Wind Datas Available.',
    'model_plural' => 'Wind Datas',
    'model_was_added' => 'Wind Data was successfully added.',
    'model_was_retrieved' => 'Wind Data was successfully retrieved.',
    'models_were_retrieved' => 'Wind Datas were successfully retrieved.',
    'model_was_updated' => 'Wind Data was successfully updated.',
    'model_was_deleted' => 'Wind Data was successfully deleted.',
    ...
    'model_id_camel_case' => 'wind dataId',
