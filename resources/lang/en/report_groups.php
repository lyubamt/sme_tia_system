...
return [
    ...
    'index_route_description' => 'Retrieve existing report groups.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the report group property name where the value is the assigned value to the retrieved report group.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved report group.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of report groups per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved report group.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new report group.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing report group.',
    ...
    'show_route_description' => 'Retrieve existsing report group.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the report group to retrieve',
    'destroy_route_description' => 'Delete existsing report group.',
    ...
    'the_id_of_model_to_delete' => 'The id of the report group to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete report groups.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the report group.',
    ...
    'the_requested_model_does_not_exists' => 'The requested report group does not exists.',
    ...
    'create' => 'Create New Report Group',
    'delete' => 'Delete Report Group',
    'edit' => 'Edit Report Group',
    'show' => 'Show Report Group',
    'show_all' => 'Show All Report Group',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Report Group.',
    'none_available' => 'No Report Groups Available.',
    'model_plural' => 'Report Groups',
    'model_was_added' => 'Report Group was successfully added.',
    'model_was_retrieved' => 'Report Group was successfully retrieved.',
    'models_were_retrieved' => 'Report Groups were successfully retrieved.',
    'model_was_updated' => 'Report Group was successfully updated.',
    'model_was_deleted' => 'Report Group was successfully deleted.',
    ...
    'model_id_camel_case' => 'report groupId',
