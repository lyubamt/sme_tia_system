...
return [
    ...
    'index_route_description' => 'Retrieve existing instruments.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the instrument property name where the value is the assigned value to the retrieved instrument.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved instrument.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of instruments per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved instrument.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new instrument.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing instrument.',
    ...
    'show_route_description' => 'Retrieve existsing instrument.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the instrument to retrieve',
    'destroy_route_description' => 'Delete existsing instrument.',
    ...
    'the_id_of_model_to_delete' => 'The id of the instrument to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete instruments.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the instrument.',
    ...
    'the_requested_model_does_not_exists' => 'The requested instrument does not exists.',
    ...
    'show' => 'Show Instrument',
    'show_all' => 'Show All Instrument',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Instrument.',
    'none_available' => 'No Instruments Available.',
    'model_plural' => 'Instruments',
    'model_was_added' => 'Instrument was successfully added.',
    'model_was_retrieved' => 'Instrument was successfully retrieved.',
    'models_were_retrieved' => 'Instruments were successfully retrieved.',
    'model_was_updated' => 'Instrument was successfully updated.',
    'model_was_deleted' => 'Instrument was successfully deleted.',
    ...
    'model_id_camel_case' => 'instrumentId',
