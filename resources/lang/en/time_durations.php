...
return [
    ...
    'index_route_description' => 'Retrieve existing time durations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the time duration property name where the value is the assigned value to the retrieved time duration.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved time duration.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of time durations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved time duration.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new time duration.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing time duration.',
    ...
    'show_route_description' => 'Retrieve existsing time duration.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the time duration to retrieve',
    'destroy_route_description' => 'Delete existsing time duration.',
    ...
    'the_id_of_model_to_delete' => 'The id of the time duration to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete time durations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the time duration.',
    ...
    'the_requested_model_does_not_exists' => 'The requested time duration does not exists.',
    ...
    'create' => 'Create New Time Duration',
    'delete' => 'Delete Time Duration',
    'edit' => 'Edit Time Duration',
    'show' => 'Show Time Duration',
    'show_all' => 'Show All Time Duration',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Time Duration.',
    'none_available' => 'No Time Durations Available.',
    'model_plural' => 'Time Durations',
    'model_was_added' => 'Time Duration was successfully added.',
    'model_was_retrieved' => 'Time Duration was successfully retrieved.',
    'models_were_retrieved' => 'Time Durations were successfully retrieved.',
    'model_was_updated' => 'Time Duration was successfully updated.',
    'model_was_deleted' => 'Time Duration was successfully deleted.',
    ...
    'model_id_camel_case' => 'time durationId',
