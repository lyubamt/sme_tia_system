...
return [
    ...
    'delivery_subcription_cost_id' => 'Delivery Subcription Cost',
    'delivery_subcription_cost_id__placeholder' => 'Select delivery subcription cost',
    'user_id' => 'User',
    'user_id__placeholder' => 'Select user',
    'expiry_date' => 'Expiry Date',
    'expiry_date__placeholder' => 'Enter expiry date here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing delivery subcriptions.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the delivery subcription property name where the value is the assigned value to the retrieved delivery subcription.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved delivery subcription.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of delivery subcriptions per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved delivery subcription.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new delivery subcription.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing delivery subcription.',
    ...
    'show_route_description' => 'Retrieve existsing delivery subcription.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the delivery subcription to retrieve',
    'destroy_route_description' => 'Delete existsing delivery subcription.',
    ...
    'the_id_of_model_to_delete' => 'The id of the delivery subcription to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete delivery subcriptions.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the delivery subcription.',
    ...
    'the_requested_model_does_not_exists' => 'The requested delivery subcription does not exists.',
    ...
    'create' => 'Create New Delivery Subcription',
    'delete' => 'Delete Delivery Subcription',
    'edit' => 'Edit Delivery Subcription',
    'show' => 'Show Delivery Subcription',
    'show_all' => 'Show All Delivery Subcription',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Delivery Subcription.',
    'none_available' => 'No Delivery Subcriptions Available.',
    'model_plural' => 'Delivery Subcriptions',
    'model_was_added' => 'Delivery Subcription was successfully added.',
    'model_was_retrieved' => 'Delivery Subcription was successfully retrieved.',
    'models_were_retrieved' => 'Delivery Subcriptions were successfully retrieved.',
    'model_was_updated' => 'Delivery Subcription was successfully updated.',
    'model_was_deleted' => 'Delivery Subcription was successfully deleted.',
    ...
    'model_id_camel_case' => 'delivery subcriptionId',
