...
return [
    ...
    'index_route_description' => 'Retrieve existing weather parameters.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the weather parameter property name where the value is the assigned value to the retrieved weather parameter.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved weather parameter.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of weather parameters per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved weather parameter.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new weather parameter.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing weather parameter.',
    ...
    'show_route_description' => 'Retrieve existsing weather parameter.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the weather parameter to retrieve',
    'destroy_route_description' => 'Delete existsing weather parameter.',
    ...
    'the_id_of_model_to_delete' => 'The id of the weather parameter to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete weather parameters.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the weather parameter.',
    ...
    'the_requested_model_does_not_exists' => 'The requested weather parameter does not exists.',
    ...
    'create' => 'Create New Weather Parameter',
    'delete' => 'Delete Weather Parameter',
    'edit' => 'Edit Weather Parameter',
    'show' => 'Show Weather Parameter',
    'show_all' => 'Show All Weather Parameter',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Weather Parameter.',
    'none_available' => 'No Weather Parameters Available.',
    'model_plural' => 'Weather Parameters',
    'model_was_added' => 'Weather Parameter was successfully added.',
    'model_was_retrieved' => 'Weather Parameter was successfully retrieved.',
    'models_were_retrieved' => 'Weather Parameters were successfully retrieved.',
    'model_was_updated' => 'Weather Parameter was successfully updated.',
    'model_was_deleted' => 'Weather Parameter was successfully deleted.',
    ...
    'model_id_camel_case' => 'weather parameterId',
