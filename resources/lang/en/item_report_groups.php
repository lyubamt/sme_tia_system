...
return [
    ...
    'report_group_section_id' => 'Report Group Section',
    'report_group_section_id__placeholder' => 'Select report group section',
    'item_category_id' => 'Item Category',
    'item_category_id__placeholder' => 'Select item category',
    ...
    'index_route_description' => 'Retrieve existing item report groups.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the item report group property name where the value is the assigned value to the retrieved item report group.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved item report group.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of item report groups per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved item report group.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new item report group.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing item report group.',
    ...
    'show_route_description' => 'Retrieve existsing item report group.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the item report group to retrieve',
    'destroy_route_description' => 'Delete existsing item report group.',
    ...
    'the_id_of_model_to_delete' => 'The id of the item report group to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete item report groups.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the item report group.',
    ...
    'the_requested_model_does_not_exists' => 'The requested item report group does not exists.',
    ...
    'create' => 'Create New Item Report Group',
    'delete' => 'Delete Item Report Group',
    'edit' => 'Edit Item Report Group',
    'show' => 'Show Item Report Group',
    'show_all' => 'Show All Item Report Group',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Item Report Group.',
    'none_available' => 'No Item Report Groups Available.',
    'model_plural' => 'Item Report Groups',
    'model_was_added' => 'Item Report Group was successfully added.',
    'model_was_retrieved' => 'Item Report Group was successfully retrieved.',
    'models_were_retrieved' => 'Item Report Groups were successfully retrieved.',
    'model_was_updated' => 'Item Report Group was successfully updated.',
    'model_was_deleted' => 'Item Report Group was successfully deleted.',
    ...
    'model_id_camel_case' => 'item report groupId',
