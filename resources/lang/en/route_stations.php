...
return [
    ...
    'lat' => 'Lat',
    'lat__placeholder' => 'Enter lat here...',
    'lon' => 'Lon',
    'lon__placeholder' => 'Enter lon here...',
    ...
    'index_route_description' => 'Retrieve existing route stations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the route station property name where the value is the assigned value to the retrieved route station.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved route station.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of route stations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved route station.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new route station.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing route station.',
    ...
    'show_route_description' => 'Retrieve existsing route station.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the route station to retrieve',
    'destroy_route_description' => 'Delete existsing route station.',
    ...
    'the_id_of_model_to_delete' => 'The id of the route station to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete route stations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the route station.',
    ...
    'the_requested_model_does_not_exists' => 'The requested route station does not exists.',
    ...
    'create' => 'Create New Route Station',
    'delete' => 'Delete Route Station',
    'edit' => 'Edit Route Station',
    'show' => 'Show Route Station',
    'show_all' => 'Show All Route Station',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Route Station.',
    'none_available' => 'No Route Stations Available.',
    'model_plural' => 'Route Stations',
    'model_was_added' => 'Route Station was successfully added.',
    'model_was_retrieved' => 'Route Station was successfully retrieved.',
    'models_were_retrieved' => 'Route Stations were successfully retrieved.',
    'model_was_updated' => 'Route Station was successfully updated.',
    'model_was_deleted' => 'Route Station was successfully deleted.',
    ...
    'model_id_camel_case' => 'route stationId',
