...
return [
    ...
    'index_route_description' => 'Retrieve existing element edata targets.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the element edata target property name where the value is the assigned value to the retrieved element edata target.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved element edata target.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of element edata targets per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved element edata target.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new element edata target.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing element edata target.',
    ...
    'show_route_description' => 'Retrieve existsing element edata target.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the element edata target to retrieve',
    'destroy_route_description' => 'Delete existsing element edata target.',
    ...
    'the_id_of_model_to_delete' => 'The id of the element edata target to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete element edata targets.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the element edata target.',
    ...
    'the_requested_model_does_not_exists' => 'The requested element edata target does not exists.',
    ...
    'create' => 'Create New Element Edata Target',
    'delete' => 'Delete Element Edata Target',
    'edit' => 'Edit Element Edata Target',
    'show' => 'Show Element Edata Target',
    'show_all' => 'Show All Element Edata Target',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Element Edata Target.',
    'none_available' => 'No Element Edata Targets Available.',
    'model_plural' => 'Element Edata Targets',
    'model_was_added' => 'Element Edata Target was successfully added.',
    'model_was_retrieved' => 'Element Edata Target was successfully retrieved.',
    'models_were_retrieved' => 'Element Edata Targets were successfully retrieved.',
    'model_was_updated' => 'Element Edata Target was successfully updated.',
    'model_was_deleted' => 'Element Edata Target was successfully deleted.',
    ...
    'model_id_camel_case' => 'element edata targetId',
