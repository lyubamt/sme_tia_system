...
return [
    ...
    'help_id' => 'Help',
    'help_id__placeholder' => 'Select help',
    ...
    'index_route_description' => 'Retrieve existing help engagements.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the help engagement property name where the value is the assigned value to the retrieved help engagement.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved help engagement.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of help engagements per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved help engagement.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new help engagement.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing help engagement.',
    ...
    'show_route_description' => 'Retrieve existsing help engagement.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the help engagement to retrieve',
    'destroy_route_description' => 'Delete existsing help engagement.',
    ...
    'the_id_of_model_to_delete' => 'The id of the help engagement to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete help engagements.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the help engagement.',
    ...
    'the_requested_model_does_not_exists' => 'The requested help engagement does not exists.',
    ...
    'create' => 'Create New Help Engagement',
    'delete' => 'Delete Help Engagement',
    'edit' => 'Edit Help Engagement',
    'show' => 'Show Help Engagement',
    'show_all' => 'Show All Help Engagement',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Help Engagement.',
    'none_available' => 'No Help Engagements Available.',
    'model_plural' => 'Help Engagements',
    'model_was_added' => 'Help Engagement was successfully added.',
    'model_was_retrieved' => 'Help Engagement was successfully retrieved.',
    'models_were_retrieved' => 'Help Engagements were successfully retrieved.',
    'model_was_updated' => 'Help Engagement was successfully updated.',
    'model_was_deleted' => 'Help Engagement was successfully deleted.',
    ...
    'model_id_camel_case' => 'help engagementId',
