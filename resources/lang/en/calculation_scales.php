...
return [
    ...
    'index_route_description' => 'Retrieve existing calculation scales.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the calculation scale property name where the value is the assigned value to the retrieved calculation scale.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved calculation scale.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of calculation scales per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved calculation scale.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new calculation scale.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing calculation scale.',
    ...
    'show_route_description' => 'Retrieve existsing calculation scale.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the calculation scale to retrieve',
    'destroy_route_description' => 'Delete existsing calculation scale.',
    ...
    'the_id_of_model_to_delete' => 'The id of the calculation scale to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete calculation scales.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the calculation scale.',
    ...
    'the_requested_model_does_not_exists' => 'The requested calculation scale does not exists.',
    ...
    'create' => 'Create New Calculation Scale',
    'delete' => 'Delete Calculation Scale',
    'edit' => 'Edit Calculation Scale',
    'show' => 'Show Calculation Scale',
    'show_all' => 'Show All Calculation Scale',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Calculation Scale.',
    'none_available' => 'No Calculation Scales Available.',
    'model_plural' => 'Calculation Scales',
    'model_was_added' => 'Calculation Scale was successfully added.',
    'model_was_retrieved' => 'Calculation Scale was successfully retrieved.',
    'models_were_retrieved' => 'Calculation Scales were successfully retrieved.',
    'model_was_updated' => 'Calculation Scale was successfully updated.',
    'model_was_deleted' => 'Calculation Scale was successfully deleted.',
    ...
    'model_id_camel_case' => 'calculation scaleId',
