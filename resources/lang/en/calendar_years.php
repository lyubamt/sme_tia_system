...
return [
    ...
    'index_route_description' => 'Retrieve existing calendar years.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the calendar year property name where the value is the assigned value to the retrieved calendar year.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved calendar year.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of calendar years per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved calendar year.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new calendar year.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing calendar year.',
    ...
    'show_route_description' => 'Retrieve existsing calendar year.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the calendar year to retrieve',
    'destroy_route_description' => 'Delete existsing calendar year.',
    ...
    'the_id_of_model_to_delete' => 'The id of the calendar year to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete calendar years.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the calendar year.',
    ...
    'the_requested_model_does_not_exists' => 'The requested calendar year does not exists.',
    ...
    'create' => 'Create New Calendar Year',
    'delete' => 'Delete Calendar Year',
    'edit' => 'Edit Calendar Year',
    'show' => 'Show Calendar Year',
    'show_all' => 'Show All Calendar Year',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Calendar Year.',
    'none_available' => 'No Calendar Years Available.',
    'model_plural' => 'Calendar Years',
    'model_was_added' => 'Calendar Year was successfully added.',
    'model_was_retrieved' => 'Calendar Year was successfully retrieved.',
    'models_were_retrieved' => 'Calendar Years were successfully retrieved.',
    'model_was_updated' => 'Calendar Year was successfully updated.',
    'model_was_deleted' => 'Calendar Year was successfully deleted.',
    ...
    'model_id_camel_case' => 'calendar yearId',
