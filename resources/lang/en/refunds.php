...
return [
    ...
    'index_route_description' => 'Retrieve existing refunds.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the refund property name where the value is the assigned value to the retrieved refund.',
    ...
    'show_route_description' => 'Retrieve existsing refund.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the refund to retrieve',
    'destroy_route_description' => 'Delete existsing refund.',
    ...
    'the_id_of_model_to_delete' => 'The id of the refund to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete refunds.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the refund.',
    ...
    'the_requested_model_does_not_exists' => 'The requested refund does not exists.',
    ...
    'edit' => 'Edit Refund',
    'show' => 'Show Refund',
    'show_all' => 'Show All Refund',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Refund.',
    'none_available' => 'No Refunds Available.',
    'model_plural' => 'Refunds',
    'model_was_added' => 'Refund was successfully added.',
    'model_was_retrieved' => 'Refund was successfully retrieved.',
    'models_were_retrieved' => 'Refunds were successfully retrieved.',
    'model_was_updated' => 'Refund was successfully updated.',
    'model_was_deleted' => 'Refund was successfully deleted.',
