...
return [
    ...
    'index_route_description' => 'Retrieve existing data flag statuses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the data flag status property name where the value is the assigned value to the retrieved data flag status.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved data flag status.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of data flag statuses per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved data flag status.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new data flag status.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing data flag status.',
    ...
    'show_route_description' => 'Retrieve existsing data flag status.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the data flag status to retrieve',
    'destroy_route_description' => 'Delete existsing data flag status.',
    ...
    'the_id_of_model_to_delete' => 'The id of the data flag status to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete data flag statuses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the data flag status.',
    ...
    'the_requested_model_does_not_exists' => 'The requested data flag status does not exists.',
    ...
    'create' => 'Create New Data Flag Status',
    'delete' => 'Delete Data Flag Status',
    'edit' => 'Edit Data Flag Status',
    'show' => 'Show Data Flag Status',
    'show_all' => 'Show All Data Flag Status',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Data Flag Status.',
    'none_available' => 'No Data Flag Statuses Available.',
    'model_plural' => 'Data Flag Statuses',
    'model_was_added' => 'Data Flag Status was successfully added.',
    'model_was_retrieved' => 'Data Flag Status was successfully retrieved.',
    'models_were_retrieved' => 'Data Flag Statuses were successfully retrieved.',
    'model_was_updated' => 'Data Flag Status was successfully updated.',
    'model_was_deleted' => 'Data Flag Status was successfully deleted.',
    ...
    'model_id_camel_case' => 'data flag statusId',
