...
return [
    ...
    'index_route_description' => 'Retrieve existing data flag types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the data flag type property name where the value is the assigned value to the retrieved data flag type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved data flag type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of data flag types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved data flag type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new data flag type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing data flag type.',
    ...
    'show_route_description' => 'Retrieve existsing data flag type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the data flag type to retrieve',
    'destroy_route_description' => 'Delete existsing data flag type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the data flag type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete data flag types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the data flag type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested data flag type does not exists.',
    ...
    'create' => 'Create New Data Flag Type',
    'delete' => 'Delete Data Flag Type',
    'edit' => 'Edit Data Flag Type',
    'show' => 'Show Data Flag Type',
    'show_all' => 'Show All Data Flag Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Data Flag Type.',
    'none_available' => 'No Data Flag Types Available.',
    'model_plural' => 'Data Flag Types',
    'model_was_added' => 'Data Flag Type was successfully added.',
    'model_was_retrieved' => 'Data Flag Type was successfully retrieved.',
    'models_were_retrieved' => 'Data Flag Types were successfully retrieved.',
    'model_was_updated' => 'Data Flag Type was successfully updated.',
    'model_was_deleted' => 'Data Flag Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'data flag typeId',
