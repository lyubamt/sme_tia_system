    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('countries.create') }}</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.countries.country.store') }}" accept-charset="UTF-8" id="create_country_form" name="create_country_form" class="form-horizontal">
            {{ csrf_field() }}
