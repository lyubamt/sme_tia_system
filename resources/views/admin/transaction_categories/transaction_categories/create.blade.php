...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h4 class="my-1 float-left">Add Transaction Category</h4>

            <div class="btn-group btn-group-sm float-right" role="group">
                <a href="{{ route('admin.transaction_categories.transaction_category.index') }}" class="btn btn-primary" title="Show all transaction categories">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.transaction_categories.transaction_category.store') }}" accept-charset="UTF-8" enctype="multipart/form-data" id="create_transaction_category_form" name="create_transaction_category_form" class="form-horizontal">
            {{ csrf_field() }}
            @include ('admin.transaction_categories.transaction_categories.form', [
