                    ...
                    <td>
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="btn-group btn-group-xs float-right" role="group">
                                ...
                                <a href="{{ route('admin.transactions.transaction.edit', $transaction->id ) }}" class="btn btn-primary" title="Edit Expense">
                                    <span class="fas fa-pencil-alt" aria-hidden="true"></span>
                                </a>

                                <button type="submit" class="btn btn-danger" title="Delete Expense" onclick="return confirm(&quot;Do you want to delete this Expense?&quot;)">
