...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h4 class="my-1 float-left">Sales</h4>
                    ...
                    <td>
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="btn-group btn-group-xs float-right" role="group">
                                ...
                                <a href="{{ route('admin.transactions.transaction.edit', $transaction->id ) }}" class="btn btn-primary" title="Edit sale">
                                    <span class="fas fa-pencil-alt" aria-hidden="true"></span>
                                </a>

                                <button type="submit" class="btn btn-danger" title="Delete sale" onclick="return confirm(&quot;Do you want to delete this sale?&quot;)">
