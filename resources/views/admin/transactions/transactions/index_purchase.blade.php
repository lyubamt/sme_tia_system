...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h4 class="my-1 float-left">Purchases</h4>
                    ...
                    <td>
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="btn-group btn-group-xs float-right" role="group">
                                ...
                                <a href="{{ route('admin.transactions.transaction.edit', $transaction->id ) }}" class="btn btn-primary" title="Edit purchase">
                                    <span class="fas fa-pencil-alt" aria-hidden="true"></span>
                                </a>

                                <button type="submit" class="btn btn-danger" title="Delete purchase" onclick="return confirm(&quot;Do you want to delete this purchase?&quot;)">
