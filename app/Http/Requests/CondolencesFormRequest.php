...
class CondolencesFormRequest extends FormRequest
{
    /**
    ...
    {
        $data = $this->only(['member_id', 'member_relative_id', 'day', 'month', 'year', 'bank_account_id', 'amount', 'status', 'user_id']);
